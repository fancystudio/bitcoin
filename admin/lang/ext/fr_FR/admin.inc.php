<?php
$lang['admin']['msg_notimedifference'] = 'Aucune diff&eacute;rence de date du syst&egrave;me de fichiers trouv&eacute;es';
$lang['admin']['error_timedifference'] = 'Date du syst&egrave;me de fichiers diff&eacute;rent du serveur';
$lang['admin']['server_time_diff'] = 'V&eacute;rification des diff&eacute;rences de date du syst&egrave;me de fichiers';
$lang['admin']['tz_offset'] = 'D&eacute;calage horaire';
$lang['admin']['gcb_name_help'] = '(Ne peut contenir que des lettres et des chiffres)&nbsp;';
$lang['admin']['pagedefaultsupdated'] = 'Param&egrave;tres de la page par d&eacute;faut mis &agrave; jour';
$lang['admin']['help_function_module_available'] = '<h3>Que fait cette Balise ?</h3>
Une balise pour tester si un module donn&eacute; (par nom) est install&eacute;
<h3>Comment l&#039;utiliser ?</h3>
<ul>
<li><strong>(requis)</strong> module - (string) Le nom du module.</li>
<li><em>(option)</em> assign - Assigne la sortie de la balise &agrave; la variable Smarty nomm&eacute;e.</li>
</ul>
<h3>Exemple:</h3>
{module_available module=&#039;News&#039; assign=&#039;havenews&#039;}{if \$havenews}{cms_module module=News}{/if}
<h3>Note :</h3>
<p>Vous ne pouvez pas utiliser la balise du module appel&eacute;. Ex : <em>{News}</em> dans cette expression</p>';
$lang['admin']['prettyurls_noeffect'] = 'Les Pretty URLs (mod_rewrite) ne sont pas configur&eacute;es ... cette URL n&#039;aura aucun effet';
$lang['admin']['help_function_cms_lang_info'] = '<h3>Que fait cette Balise ?</h3>
<p>Cette balise retourne un objet contenant les informations que CMSMS a sur la langue s&eacute;lectionn&eacute;e. Cela peut inclure des informations de localisation, les codages, la langue, alias, etc...</p>
<h3>Comment l&#039;utiliser ?</h3>
<ul>
<li><em>(option)</em> lang - La langue qui retourne les informations. Si le param&egrave;tre &quot;lang&quot; n&#039;est pas sp&eacute;cifi&eacute; alors l&#039;information pour le langage courant CMSMS est utilis&eacute;.</li>
<li><em>(option)</em> assign - Assigne la sortie de la balise &agrave; la variable Smarty nomm&eacute;e.</li>
</ul>
<h3>Exemple :</h3>
...
<p>Cette balise d&eacute;fini le langage courant pour une utilisation des cha&icirc;nes de traduction et de mise en forme de la date &agrave; la langue d&eacute;sir&eacute;e. La langue sp&eacute;cifi&eacute;e doit &ecirc;tre connue de CMSMS (Le fichier nls doit exister ). Lorsque cette fonction est appel&eacute;e, (et &agrave; moins de substitution dans le fichier config.php) une tentative sera faite pour d&eacute;finir les param&egrave;tres r&eacute;gionaux depuis la variable PHP &quot;locale&quot; associ&eacute;e &agrave; la langue. La localisation de la langue doit &ecirc;tre install&eacute; sur le serveur.</p>
<h3>Comment l&#039;utiliser ?</h3>
<ul>
<li><strong>(requis)</strong> lang - La langue souhait&eacute;e. La langue doit &ecirc;tre connue &agrave; l&#039;installation de CMSMS (Le fichier nls doit exister).</li>
</ul>';
$lang['admin']['help_function_cms_get_language'] = '<h3>Que fait cette Balise ?</h3>
<p>Cette balise retourne le nom du langage courant CMSMS. La langue est utilis&eacute;e pour les cha&icirc;nes de traduction et de mise en forme la date.</p>
<h3>Comment l&#039;utiliser ?</h3>
<ul>
<li><em>(option)</em> assign - Assigne la sortie de la balise &agrave; la variable Smarty nomm&eacute;e.nes de traduction et de mise en forme la date.</p>
<h3>Comment l</h3>
<ul>
';
$lang['admin']['help_modifier_cms_escape'] = '<h3>Que fait cette Balise ?</h3>
<p>Ce modificateur est utilis&eacute; pour &eacute;chapper la cha&icirc;ne dans une des nombreuses fa&ccedil;ons. Ceci peut &ecirc;tre utilis&eacute; pour convertir la cha&icirc;ne en plusieurs formats d&#039;affichage diff&eacute;rents, ou pour les donn&eacute;es entr&eacute;es par l&#039;utilisateur avec des caract&egrave;res sp&eacute;ciaux affichables sur une page Web standard.</p>
<h3>Comment l&#039;utiliser ?</h3>
<pre><code>{$une_variable_avec_texte|cms_escape[Type_&eacute;chappement|[Jeu_de_caract&egrave;res]}</code></pre>
<h4>Types d&#039;&eacute;chappement valides : Note traduction &agrave; valider</h4>
<ul>
<li>html <em>(defaut)</em> - use htmlspecialchars - utlise htmlspecialchars.</li>
 <li>htmlall - use htmlentities - utlise htmlentities.</li>
<li>url - raw URL encode all entities - URL brute pour coder toutes les entit&eacute;s.</li>
<li>urlpathinfo - Similar to the URL escape type, but also encode /.</li>
<li>quotes - Escape unescaped single quotes - &eacute;chappe les apostrophes.</li>
<li>hex - Escape every character into hex - &eacute;chappe les caract&egrave;res en hexad&eacute;cimal.</li>
<li>hexentity - Hex encode every character - encode en hexad&eacute;cimal chaque caract&egrave;re.</li>
<li>decentity - Decimal encode every character - encode en d&eacute;cimal chaque caract&egrave;re.</li>
<li>javascript - Escape quotes, backslashes, newlines etc - &eacute;chappe les quotes, backslashes, newlines, ... .</li>
<li>mail - Encode an email address into something that is safe to display - encode une adresse email dans une cha&icirc;ne s&ucirc;re pour l&#039;affichage. </li>
<li>nonstd - Escape non standard characters, such as document quotes - encode des caract&egrave;res non standard.</li>
</ul>
<h4>Jeu de caract&egrave;res :</h4>
<p>Si le jeu de caract&egrave;res n&#039;est pas sp&eacute;cifi&eacute;, UTF-8 est utilis&eacute;. Le jeu de caract&egrave;res est seulement applicable au &quot;html&quot; et au type d&#039;&eacute;chappement &quot;htmlall&quot;.</p>';
$lang['admin']['help_modifier_cms_date_format'] = '<h3>Que fait cette Balise ?</h3>
 <p>Ce modificateur est utilis&eacute; pour formater des dates dans un format adapt&eacute;. Il utilise les param&egrave;tres standard de &quot;strftime&quot;. Si aucune cha&icirc;ne de format est sp&eacute;cifi&eacute;, le syst&egrave;me utilisera le &quot;Format de la date&quot; dans &quot;Mon compte/Pr&eacute;f&eacute;rences utilisateur&quot; (pour les utilisateurs connect&eacute;s) ou format des dates du syst&egrave;me.</p>
...
<h3>Comment l&#039;utiliser ?</h3>
<pre><code>{$une_variable_date|cms_date_format[format de cha&icirc;ne]}</code></pre>
<h3>Exemple :</h3>
<pre><code>{&#039;2012-03-24 22:44:22&#039;|cms_date_format}</code></pre>';
$lang['admin']['help_modifier_summarize'] = '<h3>Que fait cette Balise ?</h3>
<p>Ce modificateur est utilis&eacute; pour tronquer une longue s&eacute;quence de texte &agrave; un nombre limit&eacute; de &quot;mots&quot;.</p>
<h3>Comment l&#039;utiliser ?</h3>
<pre><code>{$une_variable_avec_long_texte|summarize:nombre}</code></pre>
<h3>Exemple :</h3>
<p>L&#039;exemple suivant supprime tous les balises html du contenu et le tronque apr&egrave;s 50 mots.</p>
<pre><code>{content|strip_tags|summarize:50}</code></pre>';
$lang['admin']['module_param_lang'] = '<strong>obsol&egrave;te</strong> - Remplace le langage courant qui est utilis&eacute; pour s&eacute;lectionner les cha&icirc;nes traduites. Plus utilis&eacute; depuis version 1.11';
$lang['admin']['server_db_grants'] = 'Privil&egrave;ges d&#039;acc&egrave;s &agrave; la base de donn&eacute;es';
$lang['admin']['error_nograntall_found'] = 'Impossible de trouver un privil&egrave;ge &quot;GRANT ALL&quot;.  Cela peut signifier que vous pourriez avoir des probl&egrave;mes pour installer ou retirer des modules, ou encore l &#039;ajout et la suppression d&#039;&eacute;l&eacute;ments, y compris les pages.';
$lang['admin']['msg_grantall_found'] = 'Trouv&eacute; un privil&egrave;ge &quot;GRANT ALL&quot; qui semble &ecirc;tre adapt&eacute;';
$lang['admin']['curlversion'] = 'Test de la version de cURL';
$lang['admin']['curl'] = 'Test pour la biblioth&egrave;que cURL';
$lang['admin']['test_curl'] = 'Test de la disponibilit&eacute; de cURL';
$lang['admin']['test_curlversion'] = 'Test de la version de cURL';
$lang['admin']['curl_versionstr'] = 'version %s, la version minimale recommand&eacute;e est %s';
$lang['admin']['lines_in_error'] = '%d lignes avec erreurs';
$lang['admin']['no_files_scanned'] = 'Aucun fichier scann&eacute; au cours du processus de v&eacute;rification (le fichier est peut-&ecirc;tre invalide).';
$lang['admin']['stylesheetnotfound'] = 'Feuille de style %d non trouv&eacute;e';
$lang['admin']['sysmain_updateurls'] = 'Mise &agrave; jour de la table routes&nbsp;';
$lang['admin']['sysmain_confirmupdateurls'] = '&Ecirc;tes-vous s&ucirc;r(e) de rafraichir la table routes ?';
$lang['admin']['routesrebuilt'] = 'La table routes est reconstruite';
$lang['admin']['text_changeowner'] = 'Changer les pages s&eacute;lectionn&eacute;es pour un autre propri&eacute;taire';
$lang['admin']['changeowner'] = 'Modifiez le propri&eacute;taire';
$lang['admin']['xmlreader_class'] = 'V&eacute;rification si la classe XMLReader existe';
$lang['admin']['info_smarty_cacheudt'] = 'Si activ&eacute;, tous les appels vers les balises d&eacute;finies par l&#039;utilisateur seront mis en cache. Cela sera utile pour les balises qui affichent la sortie de requ&ecirc;tes de bases de donn&eacute;es. Vous pouvez d&eacute;sactiver le cache en utilisant le param&egrave;tre nocache dans l&#039;appel de la balise utilisateur.  Exemple : <code>{mabalise_utilisateur nocache}</code>';
$lang['admin']['prompt_smarty_cacheudt'] = 'Cache des appels balises utilisateur ';
$lang['admin']['always'] = 'Toujours';
$lang['admin']['never'] = 'Jamais';
$lang['admin']['moduledecides'] = 'Le module d&eacute;cide';
$lang['admin']['info_smarty_cachemodules'] = 'S&eacute;lectionnez comment mettre en cache les balises dans les divers gabarits qui font appel &agrave; des actions du module. Si activ&eacute;, tous les appels module seront mis en cache. Cela peut avoir des effets n&eacute;gatifs sur certains modules, ou sur des modules avec des formulaires. <em> (Note : Vous pouvez remplacer cette utilisation avec l&#039;option nocache comme d&eacute;crite dans le manuel Smarty)</em>. Si d&eacute;sactiv&eacute;, aucun appel module sera mis en cache, ce qui peut avoir un effet sur la performance. Si vous s&eacute;lectionnez la permission &quot;Le module d&eacute;cide&quot;, la mise en cache ne sera pas effectu&eacute;e. Le module peut passer outre, et vous pouvez d&eacute;sactiver le cache en utilisant le param&egrave;tre nocache lors de l&#039;appel du module.';
$lang['admin']['prompt_smarty_cachemodules'] = 'Appels du module de cache';
$lang['admin']['info_smarty_compilecheck'] = 'Si d&eacute;sactiv&eacute;, Smarty ne v&eacute;rifiera pas les dates de modification des gabarits pour voir si ils ont &eacute;t&eacute; modifi&eacute;s. Cela peut am&eacute;liorer consid&eacute;rablement les performances. Cependant effectuer tout changement de gabarit (ou m&ecirc;me quelques changements de contenu) peut exiger une vidange du cache.';
$lang['admin']['prompt_smarty_compilecheck'] = 'Faire une v&eacute;rification de compilation';
$lang['admin']['info_smarty_options'] = 'Les options suivantes ont un effet que lorsque les options de cache sont activ&eacute;es';
$lang['admin']['info_smarty_caching2'] = 'Si activ&eacute;, la sortie des plugins sera mise en cache pour am&eacute;liorer les performances. Cela s&#039;applique uniquement &agrave; la sortie sur les pages de contenu marqu&eacute;es comme cachable, et seulement pour les utilisateurs non-administrateurs. Remarque, cette fonctionnalit&eacute; peut interf&eacute;rer avec le comportement de certains modules ou plugins, ou plugins qui utilisent des formulaires non-inline. <strong>Cette option aura aucun effet si vous utilisez PHP 5.2.x</strong>';
$lang['admin']['prompt_use_smartycaching'] = 'Activer le cache Smarty';
$lang['admin']['smarty_settings'] = 'Param&egrave;tres Smarty';
$lang['admin']['help_function_cms_init_editor'] = '<h3>Que fait cette Balise ?</h3>
  <p>Cette balise est utilis&eacute;e pour initialiser les fonctionnalit&eacute;s WYSIWYG de l&#039;&eacute;diteur WYSIWYG pour la soumission des donn&eacute;es du site Web (frontend). Ce module s&eacute;lectionnera le WYSIWYG du site Web (frontend), s&#039;il a &eacute;t&eacute; demand&eacute;, et g&eacute;n&eacute;rera le <em>code HTML appropri&eacute; (les liens JavaScript)</em> pour l&#039;affichage correct de la page charg&eacute;e. Si aucun &eacute;diteur WYSIWYG n&#039;est demand&eacute; cette balise n&#039;aura aucun effet.</p>
<h3>Comment l&amp;#039;utiliser ?</h3>
<p>La premi&egrave;re chose que vous devez faire est de s&eacute;lectionner l&#039;&eacute;diteur WYSIWYG &agrave; utiliser sur le site Web (frontend),dans la page Administration du site/Param&egrave;tres globaux/Param&egrave;tres g&eacute;n&eacute;raux. Ensuite si vous utilisez l&#039;&eacute;diteur WYSIWYG sur de nombreuses pages, il peut &ecirc;tre pr&eacute;f&eacute;rable de placer la balise {cms_init_editor} directement dans le gabarit des page. Si vous avez besoin de l&#039;&eacute;diteur WYSIWY dans un nombre limit&eacute; de pages, vous pouvez juste placer la balise dans la page par l&#039;onglet Options &quot;M&eacute;tadonn&eacute;es sp&eacute;cifiques pour cette page&quot;</p>
<h3>Quels param&egrave;tres ?</h3>
<ul>
<li><em>(option)</em> wysiwyg - Indiquez le nom du module &eacute;diteur WYSIWYG pour initialiser. Utiliser avec prudence. Si vous avez un &eacute;diteur WYSIWYG diff&eacute;rent que celui de s&eacute;lectionn&eacute; dans &quot;Param&egrave;tres globaux/Param&egrave;tres g&eacute;n&eacute;raux&quot;, cela forcera l&#039;&eacute;diteur sp&eacute;cifi&eacute; pour &ecirc;tre initialis&eacute;.</li>
<li><em>(option)</em> force=0 - Normalement, cette balise ne va pas initialiser l&#039;&eacute;diteur sp&eacute;cifi&eacute; (ou d&eacute;tect&eacute;) s&#039;il n&#039;a pas &eacute;t&eacute; marqu&eacute; comme &quot;active&quot;.</li>
<li><em>(option)</em> assign - Assigne la sortie de la balise &agrave; la variable Smarty nomm&eacute;e.</li>
</ul>';
$lang['admin']['info_pagedefaults'] = 'Ce formulaire permet de sp&eacute;cifier diverses options pour les param&egrave;tres initiaux lors de la cr&eacute;ation des pages de nouveau contenu. Les &eacute;l&eacute;ments de cette page n&#039;ont pas d&#039;effet lors de l&#039;&eacute;dition des pages d&eacute;j&agrave; existantes.';
$lang['admin']['default_contenttype'] = 'Type de contenu par d&eacute;faut&nbsp;';
$lang['admin']['info_default_contenttype'] = 'Applicable lors de l&#039;ajout de nouveaux type de contenus, cette commande sp&eacute;cifie le type qui est s&eacute;lectionn&eacute; par d&eacute;faut. Assurez-vous que l&#039;&eacute;l&eacute;ment s&eacute;lectionn&eacute; n&#039;est pas l&#039;un des &quot;types non autoris&eacute;s&quot; dans Pr&eacute;f&eacute;rences Globales/Param&egrave;tres des contenus.';
$lang['admin']['error_contenttype'] = 'Le type de contenu associ&eacute; &agrave; cette page est invalide ou non autoris&eacute;';
$lang['admin']['info_disallowed_contenttypes'] = 'S&eacute;lectionnez les types de contenu &agrave; supprimer de la liste d&eacute;roulante pour l&#039;&eacute;dition ou l&#039;ajout de contenu. Utiliser CTRL+Clic pour s&eacute;lectionner, d&eacute;s&eacute;lectionner les &eacute;l&eacute;ments. Aucun &eacute;l&eacute;ment de s&eacute;lectionn&eacute; indique que tous les types de contenu sont autoris&eacute;s<em>(s&#039;applique &agrave; tous les utilisateurs)</em>.';
$lang['admin']['disallowed_contenttypes'] = 'Types de contenu NON autoris&eacute;s&nbsp;';
$lang['admin']['search_module'] = 'Module de recherche&nbsp;';
$lang['admin']['info_search_module'] = 'S&eacute;lectionnez le module qui doit &ecirc;tre utilis&eacute; pour indexer les mots pour la recherche, et fournira les capacit&eacute;s de recherche sur le site Web';
$lang['admin']['filecreatedirbadchars'] = 'Des caract&egrave;res invalides ont &eacute;t&eacute; d&eacute;tect&eacute;s dans le nom du dossier soumis';
$lang['admin']['modulehelp_yourlang'] = 'Vue dans votre langue';
$lang['admin']['info_umask'] = 'Le &quot;umask&quot; est une valeur octale qui est utilis&eacute;e pour sp&eacute;cifier l&#039;autorisation par d&eacute;faut pour les nouveaux fichiers cr&eacute;&eacute;s (utilis&eacute; pour les fichiers dans le r&eacute;pertoire cache et les fichiers upload&eacute;s. Pour plus d&#039;informations voir un <a href="http://fr.wikipedia.org/wiki/Umask" target="_blank">article Wikip&eacute;dia.</a>';
$lang['admin']['general_operation_settings'] = 'R&eacute;glages de fonctionnement g&eacute;n&eacute;ral&nbsp;';
$lang['admin']['info_checkversion'] = 'Si activ&eacute;, une v&eacute;rification pour une nouvelle version de CMSMS sera effectu&eacute;e, une fois par jour ';
$lang['admin']['checkversion'] = 'Autoriser des contr&ocirc;les p&eacute;riodiques pour les nouvelles versions&nbsp;';
$lang['admin']['actioncontains'] = 'L&#039;action contient';
$lang['admin']['filterapplied'] = 'Filtre actuel';
$lang['admin']['automatedtask_success'] = 'T&acirc;che automatis&eacute;e r&eacute;alis&eacute;e';
$lang['admin']['siteprefsupdated'] = 'Mise &agrave; jour des Pr&eacute;f&eacute;rences Globales';
$lang['admin']['ip_addr'] = 'Addresse IP';
$lang['admin']['warn_admin_ipandcookies'] = 'Attention : les activit&eacute;s admin utilisent des cookies et votre adresse IP';
$lang['admin']['event_desc_loginfailed'] = 'Envoy&eacute; apr&egrave;s qu&#039;un utilisateur n&#039;ait pas r&eacute;ussi &agrave; se connecter &agrave; l&#039;administration';
$lang['admin']['event_help_loginfailed'] = '<p>Envoy&eacute; apr&egrave;s qu&#039;un utilisateur n&#039;ait pas r&eacute;ussi &agrave; se connecter &agrave; l&#039;administration.</p>';
...
$lang['admin']['moduleupgraded'] = 'Mise &agrave; jour termin&eacute;e avec succ&egrave;s';
$lang['admin']['added_css'] = 'CSS ajout&eacute;';
$lang['admin']['toggle'] = 'Tout';
$lang['admin']['added_group'] = 'Groupe ajout&eacute;';
$lang['admin']['expanded_xml'] = 'Fichier XML contenant de %s %s';
$lang['admin']['installed_mod'] = 'Version install&eacute;e %s';
$lang['admin']['uninstalled_mod'] = 'Module d&eacute;sinstall&eacute; %s';
$lang['admin']['upgraded_mod'] = '%s mise &agrave; depuis version %s vers %s';
$lang['admin']['edited_gcb'] = 'Bloc de contenu global &eacute;dit&eacute;';
$lang['admin']['edited_content'] = 'Contenu &eacute;dit&eacute;';
$lang['admin']['added_content'] = 'Contenu ajout&eacute;';
$lang['admin']['added_css_association'] = 'Association de feuille de style ajout&eacute;e';
$lang['admin']['deleted_group'] = 'Groupe supprim&eacute;';
$lang['admin']['deleted_content'] = 'Contenu supprim&eacute;';
$lang['admin']['edited_user'] = 'Utilisateur &eacute;dit&eacute;';
$lang['admin']['edited_udt'] = 'Balise utilisateur &eacute;dit&eacute;e';
$lang['admin']['content_copied'] = 'Contenu copi&eacute; vers %s';
$lang['admin']['deleted_template'] = 'Gabarit supprim&eacute;';
$lang['admin']['added_udt'] = 'Balise utilisateur ajout&eacute;e';
$lang['admin']['deleted_udt'] = 'Balise utilisateur supprim&eacute;e';
$lang['admin']['added_gcb'] = 'Bloc de contenu global ajout&eacute;';
$lang['admin']['edited_group'] = 'Groupe &eacute;dit&eacute;';
$lang['admin']['deleted_css_association'] = 'Association de feuille de style supprim&eacute;e';
...
$lang['admin']['deleted_css'] = 'Feuille de style supprim&eacute;e';
$lang['admin']['uploaded_file'] = 'Fichier Upload&eacute;';
$lang['admin']['created_directory'] = 'Dossier cr&eacute;&eacute;';
$lang['admin']['deleted_file'] = 'Fichier supprim&eacute;';
$lang['admin']['deleted_directory'] = 'Dossier supprim&eacute;';
$lang['admin']['edited_template'] = 'Gabarit &eacute;dit&eacute;';
$lang['admin']['deleted_user'] = 'Utilisateur supprim&eacute;';
$lang['admin']['deleted_module'] = 'Supression d&eacute;finitive de %s';
$lang['admin']['deleted_gcb'] = 'Bloc de contenu global supprim&eacute;';
$lang['admin']['added_user'] = 'Utilisateur ajout&eacute;';
$lang['admin']['edited_user_preferences'] = 'Pr&eacute;f&eacute;rences du compte utilisateur &eacute;dit&eacute;es';
$lang['admin']['added_template'] = 'Gabarit ajout&eacute;';
$lang['admin']['event_desc_stylesheetpostcompile'] = 'Envoy&eacute; apr&egrave;s une feuille de style compil&eacute;e par Smarty';
$lang['admin']['event_desc_stylesheetprecompile'] = 'Envoy&eacute; avant une feuille de style compil&eacute;e par Smarty';
$lang['admin']['confirm_uploadmodule'] = '&Ecirc;tes-vous s&ucirc;r(e) de souhaitez t&eacute;l&eacute;charger le fichier XML s&eacute;lectionn&eacute;. Un t&eacute;l&eacute;chargement incorrect de module peut casser le fonctionnement du site Web';
$lang['admin']['error_module_mincmsversion'] = 'Ce module n&eacute;cessite une version plus r&eacute;cente de CMSMS&trade;';
$lang['admin']['info_browser_cache_expiry'] = 'Sp&eacute;cifie la dur&eacute;e (en minutes) que les navigateurs devraient garder en cache les pages. Une valeur &agrave; 0 d&eacute;sactive la fonctionnalit&eacute;.';
$lang['admin']['browser_cache_expiry'] = 'Limite d&#039;expiration du cache du navigateur <em>(en minutes)</em>&nbsp;';
$lang['admin']['info_browser_cache'] = 'Applicable uniquement aux pages cachable, ce param&egrave;tre indique que les navigateurs devraient &ecirc;tre autoris&eacute;s &agrave; mettre en cache les pages pour une dur&eacute;e d&eacute;finie. La dur&eacute; conditionne les modifications du contenu des pages pour que les visiteurs qui reviennent puissent voir ou non les modifications des pages.';
$lang['admin']['allow_browser_cache'] = 'Autoriser le navigateur &agrave; garder en cache les pages&nbsp;';
$lang['admin']['server_cache_settings'] = 'Param&egrave;tres du cache serveur&nbsp;';
$lang['admin']['browser_cache_settings'] = 'Param&egrave;tres du cache du navigateur&nbsp;';
...
<h3>Quels param&egrave;tres </h3>
<ul>
<li><strong>(requis)</strong> accepted - Une virgule comme s&eacute;parateur de liste pour les deux caract&egrave;res de noms de langue accept&eacute;e.</li>
 ...
 <li><em>(option)</em> assign - Le nom de la variable Smarty pour affecter les r&eacute;sultats. Si non sp&eacute;cifi&eacute; les r&eacute;sultats de cette fonction sont retourn&eacute;s. les r</li>
</ul>';
...
$lang['admin']['info_content_autocreate_flaturls'] = 'Si &quot;Oui&quot; cela mettra toutes les URLs &agrave; la m&ecirc;me valeur que l&#039;alias de page. Remarque : Les valeurs ne seront pas synchronis&eacute;es apr&egrave;s avoir activ&eacute;.';
...
$lang['admin']['invalid_url2'] = 'L&#039;URL sp&eacute;cifi&eacute;e est invalide.  Elle ne doit contenir que des caract&egrave;res alphanum&eacute;riques, ou - ou encore /. Les extensions doivent contenir que des caract&egrave;res alphanum&eacute;riques et &ecirc;tre inf&eacute;rieure &agrave; 5 caract&egrave;res.Il est aussi possible que cette URL soit d&eacute;j&agrave; utilis&eacute;e.';
$lang['admin']['page_url'] = 'URL de page&nbsp;';
$lang['admin']['runuserplugin'] = 'Ex&eacute;cuter cette balise utilisateur';
...
<p><strong>Note :</strong> ce type de bloc doit &ecirc;tre utilis&eacute; uniquement avec les modules compatibles. Vous ne devriez pas l&#039;utiliser pour des utilisations non pr&eacute;vues par les modules.</p>
	<p>	Cette balise accepte quelques param&egrave;tres, et passe tous les autres param&eacute;tres par le module.</p>
 	<p>Param&egrave;tres :
 	 <ul>
 	 <li><strong>(requis)</strong> module - Le nom du module qui offrira ce bloc de contenu. Ce module doit &ecirc;tre install&eacute; et disponible</li>
 	 <li><strong>(requis)</strong> block  - Le nom du bloc de contenu.</li>
 	 <li><em>(option)</em> label - Un label pour le bloc de contenu pour une utilisation lors de l&#039;&eacute;dition de la page.</li>
             <li><em>(option)</em> tab - L&#039;onglet d&eacute;sir&eacute; pour afficher ce champ dans le formulaire d&#039;&eacute;dition.</li>
 	 <li><em>(option)</em> assign (string) - Assigne le r&eacute;sultat &agrave;  une variable Smarty avec ce nom.</li>	 	 
</ul>
</p>';
...
$lang['admin']['help_function_cms_stylesheet'] = '	<h3>Que fait cette Balise ?</h3>
  <p>C&#039;est un remplacement de la balise {stylesheet}. Cette nouvelle balise permet la mise en cache des fichiers CSS en g&eacute;n&eacute;rant des fichiers statiques dans le dossier tmp/cache, ainsi que le traitement des balises Smarty dans les feuilles de style.</p>
  <p>Cette balise r&eacute;cup&egrave;re les informations des styles du syst&egrave;me. Par d&eacute;faut, elle prend toutes les feuilles de style li&eacute;es au gabarit en cours, et les combine en une seule balise de feuille de style. </p>
  ...
  <p> Cette balise est le remplacement de {stylesheet} qui est d&eacute;sormais obsol&egrave;te.</p>
  <h3>Comment l&#039;utiliser ?</h3>
...
<li><em>(option)</em> nocombine - Si la valeur est une valeur non nulle, et si il y a plusieurs feuilles de style associ&eacute;es au gabarit, les feuilles de style seront s&eacute;par&eacute;es  au lieu d&#039;&ecirc;tre combin&eacute;es en une seule balise de feuille de style.</li>
<li><em>(option)</em> nolinks - S&#039;il est d&eacute;fini &agrave; une valeur non nulle, les feuilles de style auront une sortie comme une URL sans la balise &quot;lien&quot;.</li>
<li><em>(option)</em> https - (boolean) indique dans le cas o&ugrave; param&egrave;tre &quot;ssl_url&quot; du config.php est activ&eacute; de pr&eacute;fixer les URLs des feuilles de style. S&#039;il n&#039;est pas sp&eacute;cifi&eacute;, le syst&egrave;me va tenter de d&eacute;terminer l&#039;URL racine appropri&eacute;e fond&eacute;e sur la s&eacute;curit&eacute; de la page affich&eacute;e.</li>
  ...
  <li><em>(option)</em> media - <strong>[obsol&egrave;te]</strong> -  Si utilis&eacute; avec le param&egrave;tre &quot;name&quot;, ce param&egrave;tre modifiera le type de m&eacute;dia pour la feuille de style. En utilisation avec le param&egrave;tre &quot;templateid&quot;, le le type de m&eacute;dia modifiera uniquement cette feuille de style qui sera marqu&eacute;e avec le type sp&eacute;cifi&eacute;.</li>
  </ul>
...
<p>Comme les fichiers mis en cache sont g&eacute;n&eacute;r&eacute;s dans le dossier tmp/cache de l&#039;installation de CMSMS&trade;, le dossier de travail des CSS n&#039;est pas la racine du site. Par cons&eacute;quent, toutes les images, ou d&#039;autres balises qui n&eacute;cessitent une URL doit utiliser la balise [[root_url]]  pour la forcer &agrave; &ecirc;tre une URL absolue. Exemple : </p>
<pre>
<code>
h3 .error { background: url([[root_url]]/uploads/images/error_background.gif); }<br/>
</code>
</pre>
<p><strong>Note :</strong> en raison de la nature mise en cache de la balise, les variables Smarty doivent &ecirc;tre plac&eacute;es au sommet de CHAQUE feuille de style, qui est attach&eacute; au gabarit.</p>';
...
$lang['admin']['info_adminlog_lifetime'] = 'Suppression des anciennes entr&eacute;es des logs plus ag&eacute;es que ci-dessus.';
$lang['admin']['filteruser'] = 'Nom d&#039;utilisateur';
$lang['admin']['filtername'] = 'Nom de l&#039;&eacute;v&eacute;nement contient';
$lang['admin']['filteraction'] = 'L&#039;action contient';
$lang['admin']['filterapply'] = 'Appliquer les filtres';
$lang['admin']['filterreset'] = 'Remise &agrave; z&eacute;ro des filtres';
...
$lang['admin']['info_basic_attributes'] = 'Cette s&eacute;lection vous permet de sp&eacute;cifier des propri&eacute;t&eacute;s affichables de &quot;Contenu/Pages&quot; sans que les utilisateurs aient la permission (&quot;Manage All Content&quot;) de modifier la structure de la page. Les propri&eacute;t&eacute;s s&eacute;lectionn&eacute;es apparaissent dans l&#039;onglet &quot;Accueil ou Options&quot; sur le contenu de la page d&#039;&eacute;dition.';
...
<ul>
  ...
  <li><em>(option)</em> assign (string) - Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom.</code>.</li>
</ul>';
...
$lang['admin']['help_function_dump'] = '<h3>Que fait cette Balise ?</h3>
  <p>Cette balise peut &ecirc;tre utiliser pour lire (dump) le contenu de toute variable smarty dans un format plus lisible. Ceci est utile pour le d&eacute;bogage, et l&#039;&eacute;dition des gabarits, afin de conna&icirc;tre le format et le type de donn&eacute;es disponibles.</p>
<h3>Comment l&#039;utiliser ?</h3>
...
<li>maxlevel - Le nombre maximum de niveaux r&eacute;cursifs (applicable uniquement si &quot;recurse&quot; est &eacute;galement donn&eacute;. La valeur par d&eacute;faut pour ce param&egrave;tre est 3</li>
...
<p>Cette balise permet aux concepteurs de gabarits d&#039;inciter les utilisateurs &agrave; s&eacute;lectionner un fichier image lors de l&#039;&eacute;dition du contenu d&#039;une page. Il se comporte de fa&ccedil;on similaire &agrave; la balise {content}, pour ajouter d&#039;autres blocs de contenu.</p>
<h3>Comment l&#039;utiliser ?</h3>
...
<ul>
  ...
  <li><em>(option)</em> dir =&#039;&#039;- Le nom d&#039;un dossier (par rapport au dossier /uploads), &agrave; partir duquel seront s&eacute;lectionn&eacute;s les fichiers images. Si le param&egrave;tre n&#039;est pas sp&eacute;cifi&eacute;, la pr&eacute;f&eacute;rence &quot;Chemin pour les champs images&quot; dans la page Param&egrave;tres globaux/Param&egrave;tres des contenus sera utilis&eacute;e. Sinon, le dossier /uploads sera utilis&eacute;. 
...
<li><em>(option)</em> default=&#039;&#039;; - Utiliser pour d&eacute;finir une image par d&eacute;faut utilis&eacute; lorsque aucune image n&#039;est s&eacute;lectionn&eacute;e.</li>
...
<li><em>(option)</em> tab=&#039;&#039; - L&#039;onglet d&eacute;sir&eacute; pour afficher ce champ dans le formulaire d&#039;&eacute;dition.</li>
  <li><em>(option)</em> exclude=&#039;&#039; - Sp&eacute;cifie un pr&eacute;fixe de fichiers &agrave; exclure.  Exemple : thumb_</li>
  <li><em>(option)</em> sort=&#039;&#039; - &eacute;ventuellement trier les options. Par d&eacute;faut : Ne pas trier.</li>
<li><em>(option)</em> assign=&#039;&#039; (string) -  Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom</li>
</ul>';
...
<p>Cette balise va traiter les donn&eacute;es contenues dans le bloc &quot;pagedata&quot; des pages de contenu &agrave; travers Smarty. Elle permet de sp&eacute;cifier des donn&eacute;es sp&eacute;cifiques &agrave; chaque page via Smarty sans avoir &agrave; changer le gabarit de chaque page.</p>
<h3>Comment l&#039;utiliser ?</h3>
<ol>
...
$lang['admin']['systemmaintenance'] = 'Maintenance du syst&egrave;me';
$lang['admin']['systemmaintenancedescription'] = 'Diverses fonctions de maintenance de votre syst&egrave;me. Vous pouvez &eacute;galement consulter le changelog pour toutes les versions.';
$lang['admin']['sysmaintab_database'] = 'Base de donn&eacute;es';
...
$lang['admin']['sysmain_database_status'] = 'Statut de la base de donn&eacute;es';
$lang['admin']['sysmain_updatehierarchy'] = 'Mise &agrave; jour des positions hi&eacute;rarchiques des pages&nbsp;';
$lang['admin']['sysmain_confirmupdatehierarchy'] = '&Ecirc;tes-vous s&ucirc;r(e) de mettre &agrave; jour la position hi&eacute;rarchiques des pages ?';
$lang['admin']['sysmain_update'] = 'Mise &agrave; jour';
$lang['admin']['sysmain_pagesfound'] = 'pages trouv&eacute;es';
$lang['admin']['sysmain_hierarchyupdated'] = 'Les positions hi&eacute;rarchiques des pages ont &eacute;t&eacute; mise &agrave; jour';
$lang['admin']['sysmain_nostr_errors'] = 'Aucune erreur de structure n&#039;a &eacute;t&eacute; d&eacute;tect&eacute;e dans la base de donn&eacute;es';
$lang['admin']['sysmain_str_error'] = 'erreur de structure d&eacute;tect&eacute;e dans table';
$lang['admin']['sysmain_str_errors'] = 'erreurs de structure d&eacute;tect&eacute;es dans tables';
$lang['admin']['sysmain_tablesfound'] = 'tables trouv&eacute;es (dont %d sans extension _seq)';
$lang['admin']['sysmain_repair'] = 'R&eacute;paration';
$lang['admin']['sysmain_repairtables'] = 'R&eacute;parer les tables&nbsp;';
$lang['admin']['sysmain_tablesrepaired'] = 'Tables r&eacute;par&eacute;es';
$lang['admin']['sysmain_optimizetables'] = 'Optimiser les tables&nbsp;';
$lang['admin']['sysmain_tablesoptimized'] = 'Tables optimis&eacute;es';
$lang['admin']['sysmain_optimize'] = 'Optimisation';
$lang['admin']['sysmain_confirmclearcache'] = '&Ecirc;tes-vous s&ucirc;r(e) de vider le cache ?';
$lang['admin']['sysmain_nocontenterrors'] = 'Aucune erreur d&eacute;tect&eacute;e dans le contenu';
$lang['admin']['sysmain_pagesmissinalias'] = 'pages avec alias manquant';
$lang['admin']['sysmain_confirmfixaliases'] = '&Ecirc;tes-vous s&ucirc;r(e) d&#039;ajouter des alias aux pages ?';
$lang['admin']['sysmain_fixaliases'] = 'Ajouter des alias o&ugrave; ils manquent';
$lang['admin']['sysmain_aliasesfixed'] = 'alias corrig&eacute;s';
$lang['admin']['sysmain_pagesinvalidtypes'] = 'pages trouv&eacute;es sans alias valide';
$lang['admin']['sysmain_confirmfixtypes'] = '&Ecirc;tes-vous s&ucirc;r(e) de convertir vers des pages de contenu standard ?';
$lang['admin']['sysmain_fixtypes'] = 'Convertir en pages de contenu standard';
$lang['admin']['sysmain_typesfixed'] = 'types de contenu corrig&eacute;s';
...
$lang['admin']['help_function_current_date'] = '<h3 style=&quot;color: red;&quot;>ATTENTION cette balise est obsol&egrave;te.</h3>
...
<p><span style=&quot;color: #ff0000;&quot;>ATTENTION cette balise est obsol&egrave;te</span> et sera supprim&eacute; des versions futures de CMSMS&trade;.</p>
...
$lang['admin']['help_function_root_url'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Quels param&egrave;tres ?</h3>
        <p><em>(option)</em> autossl=1 - Activ&eacute; par d&eacute;faut, cette option permet de d&eacute;tecter si la demande faite au serveur &eacute;tait sur SSL, et si  l&#039;url &eacute;tait retourn&eacute;e correctement configur&eacute; en SSL. Pour d&eacute;sactiver cette fonction pr&eacute;ciser autossl = 0.</p>
<p><em>(option)</em> assign (cha&icirc;ne) - Affecte les r&eacute;sultats &agrave; une variable Smarty qui porte ce nom.</p>';
...
<li><em>(option)</em> assign (string) - Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom.</li>										 	
	...
	<pre>{recently_updated number=&#039;15&#039; showtitle=&#039;false&#039; leadin=&#039;Derni&egrave;re Modification : &#039; css_class=&#039;nom_de_classe&#039; dateformat=&#039;D M j G:i:s T Y&#039;}</pre>';
$lang['admin']['help_function_print'] = '	<h3>Que fait cette Balise ?</h3>
	...
	Au lieu d&#039;utiliser <code>{cms_module module=&#039;CMSPrinting&#039;}</code> vous pouvez aussi utiliser <code>{print}</code> pour ins&eacute;rer ce module sur vos pages/gabarits
	</p>
	<h3>Comment l&#039;utiliser ?</h3>
...
$lang['admin']['help_function_news'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{news}</code>. Pour de l&#039;aide &agrave; propos du module de news/articles, les param&egrave;tres etc..., merci de se r&eacute;f&eacute;rer &agrave; l&#039;aide du module news.News</p>';
$lang['admin']['help_function_modified_date'] = '        <h3>Que fait cette Balise ?</h3>
        ...
        <ul>
<li><em>(option)</em> format - le format de Date/Heure utilisant les param&egrave;tres de la fonction php strftime.  Voir <a href="http://php.net/strftime" target="_blank">ici</a> pour une liste des param&egrave;tres et plus d&#039;information.</li>
<li><em>(option)</em> assign - Attribuer les r&eacute;sultats &agrave; la variable Smarty.</li>
        </ul>';
$lang['admin']['help_function_metadata'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
		<li><em>(option)</em> showbase (true/false) - Si d&eacute;fini &agrave; false, la balise de base ne sera pas envoy&eacute;e.</li>
<li><em>(option)</em> assign (string) - Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom.</li>
	</ul>';
...
<li><em>(option)</em> <tt>assign (string)</tt> - Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom.de l</li>
     </ul>';
...
$lang['admin']['help_function_global_content'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<ul>
  	  <li>name - Le nom du bloc de contenu &agrave; afficher.</li>
          <li><em>(option)</em> assign - Le nom d&#039;une variable smarty auquel le bloc de contenu global doit &ecirc;tre attribu&eacute;.</li>
	</ul>';
...
$lang['admin']['help_function_uploads_url'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{uploads_url}</code></p>
	<h3>Quels param&egrave;tres ?</h3><ul>
<li><em>(option)</em> assign (string) - Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom. </li></ul>';
...
<code>{metadata}</code> est bien dans votre gabarit de page.</li>
	...
	<p>Ajouter le code suivant dans votre feuille de style CSS :</p>
        ...
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
            <li><strong>(requis)</strong> url - l&#039;URL &agrave; inclure</li> 
            <li><strong>(requis)</strong> header=true - cela g&eacute;n&eacute;rera le code pour le redimensionnement de l&#039;IFRAME.</li>
...
<p>Maintenant, lorsque vous editez une page, il y aura un texte intitul&eacute; &quot;Second Content Block&quot;.</p></li>
		<li><em>(option)</em> wysiwyg (true/false) - Si false, alors un &eacute;diteur wysiwyg ne sera jamais utilis&eacute; lors de l&#039;&eacute;dition de ce bloc. Si true, alors agit comme d&#039;habitude. Ne fonctionne que lorsque le param&egrave;tre &quot;block&quot; est utilis&eacute;.</li>
...
<li><em>(option) </em>maxlength - Applicable uniquement lorsque l&#039;option &quot;oneline&quot; est utilis&eacute; ce param&egrave;tre optionnel permet de sp&eacute;cifier la longueur maximale d&#039;entr&eacute;e pour le champ d&#039;&eacute;dition. La valeur par d&eacute;faut est de 255.</li>
...
<li><em>(optional)</em> tab - L&#039;onglet d&eacute;sir&eacute; pour afficher ce champ dans le formulaire d&#039;&eacute;dition.</li>
...
$lang['admin']['help_function_contact_form'] = '  <h2 style=&quot;color: red;&quot;>ATTENTION cette balise est obsol&egrave;te.</h2>
...
$lang['admin']['help_function_cms_selflink'] = '		<h3>Que fait cette Balise ?</h3>
		...
		<li><em>(option)</em> <tt>dir anchor (liens internes)</tt> - Nouvelle option pour une page de lien interne. Si vous utilisez cette balise <tt>anchorlink</tt> doit &ecirc;tre utilis&eacute; pour votre lien. </li> <!-- Russ - 25-04-2006 -->
...
<strong>Note :</strong> Seulement une des options peut &ecirc;tre utilis&eacute;e de la m&ecirc;me d&eacute;claration &quot;cms_selflink&quot; !</li>
		...
		<li><em>(option)</em> <tt>href</tt> - Si href est utilis&eacute; seule la valeur href est g&eacute;n&eacute;r&eacute; (pas d&#039;autres param&egrave;tres possibles). <strong>Exemple :</strong> < a href = &quot;(cms_selflink href =&quot; alias &quot;)&quot;> < img src = &quot;xx&quot; > < /a></li>
...
<li><em>(option)</em> <tt>width</tt> - Largeur pour &ecirc;tre utilis&eacute; avec l&#039;image (aucun attribut de largeur sera utilis&eacute; sur la sortie balise img s&#039;il n&#039;est pas fourni.).</li>
<li><em>(option)</em> <tt>height</tt> - Hauteur pour  &ecirc;tre utilis&eacute; avec l&#039;image (aucun attribut de hauteur sera utilis&eacute; sur la sortie balise img   s&#039;il n&#039;est pas fourni.).</li>
...
$lang['admin']['help_function_cms_module'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Cette balise sert &agrave; ins&eacute;rer des modules dans vos pages ou vos gabarits. Si un module est cr&eacute;&eacute; pour &ecirc;tre utilis&eacute; comme une balise (V&eacute;rifier les d&eacute;tails dans l&#039;aide), vous avez la possibilit&eacute; de l&#039;ins&eacute;rer &agrave; l&#039;aide de cette balise.</p>
	<h3>Comment l&#039;utiliser ?</h3>
	...
	<ul>
		<li>module - Nom du module &agrave; ins&eacute;rer. Non sensible &agrave; la casse.</h3>
</ul>';
...
$lang['admin']['help_function_breadcrumbs'] = '<h3 style=&quot;font-weight:bold;color:#f00;&quot;>Cette balise est <strong>obsol&egrave;te<strong>. Utiliser { cms_breadcrumbs } du module MenuManager maintenant !</h3>
<h3>Que fait cette Balise ?</h3>
...
<li><em>(option)</em> <tt>assign (string)</tt> - Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom.</li>
</ul>';
...
$lang['admin']['help_function_redirect_url'] = '<h3>Que fait cette Balise ?</h3>
  <p>Cette balise vous permet de faire une redirection vers une URL sp&eacute;cifique. (par exemple faire une redirection vers une page, si votre site &#039;est pas encore ouvert)</p>
<h3>Comment l&#039;utiliser ?</h3>
...
$lang['admin']['help_function_redirect_page'] = '<h3>Que fait cette Balise ?</h3>
 <p>Cette balise vous permet de faire une redirection vers une autre page (par exemple, rediriger vers la page d&#039;identification si l&#039;utilisateur n&#039;est pas connect&eacute;).</p>
<h3>Comment l&#039;utiliser ?</h3>
...
$lang['admin']['help_function_cms_jquery'] = '<h3>Que fait cette Balise ?</h3>
 <p>Cette balise vous permet d&#039;utiliser les librairies javascript et balises utilis&eacute;s pour l&#039;administration.</p>
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{cms_jquery}</code></p>
...
<h3><em>Inclus par d&eacute;faut</em></h3>
<ul>
...
<h3>Quels param&egrave;tres ?</h3>
<ul>
	<li><em>(option) </em><tt>exclude</tt> - Utilise, s&eacute;par&eacute; par des virgules(CSV),la liste des scripts que vous souhaitez exclure. <code>&#039;jquery.ui.nestedSortable.js,jquery.json.min.js&#039;</code></li>
	<li><em>(option) </em><tt>append</tt> - Utilise, s&eacute;par&eacute; par des virgules(CSV), la liste des chemins des scripts que vous souhaitez ajouter. <code>&#039;/uploads/jquery.ui.nestedSortable.js,http://code.jquery.com/jquery-1.7.1.min.js&#039;par<code>&#039;</code></li>
	<li><em>(option) </em><tt>cdn</tt> - cdn=&#039;true&#039; permet d&#039;ins&eacute;rer jQuery et jQueryUI en utilisant le r&eacute;seau Google &quot;Content Delivery Network&quot;. Par d&eacute;faut &agrave; &quot;false&quot;</li>
	<li><em>(option) </em><tt>ssl</tt> - Utilis&eacute; pour ssl_url comme le chemin de base souhait&eacute;.</li>
	<li><em>(option) </em><tt>custom_root</tt> - Utilis&eacute; pour d&eacute;finir un chemin de base souhait&eacute;. <code>custom_root=&#039;http://test.domain.com/&#039;</code> <br/>NOTE : R&eacute;&eacute;crit l&#039;option SSL et travaille avec l&#039;option cdn</li>
<li><em>(option)</em> <tt>assign (string)</tt> - Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom.</li>
</ul>';
$lang['admin']['of'] = 'sur';
...
$lang['admin']['error_delete_default_parent'] = 'Vous ne pouvez pas supprimer la page par d&eacute;faut ou un parent de la page par d&eacute;faut.';
...
$lang['admin']['adminpaneltitle'] = 'Administration de CMS Made Simple&trade;';
...
$lang['admin']['backtoplugins'] = 'Retourner &agrave; la liste des balises';
...
$lang['admin']['confirmdefault'] = '&Ecirc;tes-vous s&ucirc;r(e) de vouloir mettre :&nbsp; %s  comme page par d&eacute;faut du site ?';
...
$lang['admin']['cachenotwritable'] = 'Le dossier cache n&#039;est pas accessible en &eacute;criture. Le vidage du cache ne va pas fonctionner. Veuillez d&eacute;finir le dossier tmp/cache pour qu&#039;il aie la permission totale (lecture/&eacute;criture/ex&eacute;cution = chmod 777 <strong>chmod suivant votre h&eacute;bergement</strong>). Il se pourrait &eacute;galement que vous ayez &agrave; d&eacute;sactiver le Safe mode.';
$lang['admin']['error_nomodules'] = 'Aucun modules install&eacute; ! V&eacute;rifier dans Extensions/Modules';
$lang['admin']['modulesnotwritable'] = 'Le dossier des modules <em>(et/ou le dossier uploads)</em> n&#039;est pas accessible en &eacute;criture. Si vous d&eacute;sirez installer des modules par t&eacute;l&eacute;chargement d&#039;un fichier XML, vous devez donner la permission totale (lecture/&eacute;criture/ex&eacute;cution) sur le dossier des modules (chmod 777 ou <strong>chmod suivant votre h&eacute;bergement</strong>). Le Safe mode pourrait aussi &ecirc;tre en cause.';
...
$lang['admin']['eventhandler'] = 'Gestionnaires d&#039;&eacute;v&eacute;nements';
...
$lang['admin']['prefsupdated'] = 'Les pr&eacute;f&eacute;rences utilisateur ont &eacute;t&eacute; mises &agrave; jour.';
$lang['admin']['accountupdated'] = 'Le compte utilisateur a &eacute;t&eacute; mis &agrave; jour.';
...
$lang['admin']['setallcontentconfirm'] = '&Ecirc;tes-vous s&ucirc;r(e) que toutes les pages doivent utiliser ce gabarit&nbsp;?';
$lang['admin']['showinmenu'] = 'Afficher dans le menu&nbsp;';
$lang['admin']['use_name'] = 'Afficher le titre de la page &agrave; la place du texte du menu dans la liste d&eacute;roulante &quot;Parent&quot;&nbsp;';
...
$lang['admin']['userprefs'] = 'Pr&eacute;f&eacute;rences utilisateur';
$lang['admin']['useraccount'] = 'Compte utilisateur';
$lang['admin']['lang_settings_legend'] = 'Param&egrave;tres de langue';
$lang['admin']['content_editor_legend'] = 'Param&egrave;tres de l&#039;&eacute;diteur de contenu';
$lang['admin']['admin_layout_legend'] = 'Param&egrave;tres administrateur';
...
$lang['admin']['media_query'] = 'Media Query (requ&ecirc;tes de media)&nbsp;';
$lang['admin']['media_query_description'] = '<strong>Remarque :</strong> Lorsque Media Query est utilis&eacute;, le &quot;Type de m&eacute;dia&quot; sera ignor&eacute;.<br /> Utilisez les expression valides recommand&eacute;es par le <a href="http://www.w3.org/TR/css3-mediaqueries/" rel="external" title="W3C">W3C</a>.  Pour information <a href="http://www.alsacreations.com/article/lire/930-css3-media-queries.html" rel="external" title="Information sur Alsacreations">Les Media Queries CSS3 sur Alsacreations</a>';
...
$lang['admin']['mediatype_projection'] = 'projection&nbsp;: &agrave; l&#039;attention des pr&eacute;sentations projet&eacute;es, par exemple sur projecteurs ou impressions sur transparents.';
...
$lang['admin']['mediatype_speech'] = 'speech : Destin&eacute; &agrave; des synth&eacute;;tiseurs vocaux';
...
$lang['admin']['event_desc_templateprefetch'] = 'Envoy&eacute; avant qu&#039;un gabarit soit extrait de Smarty';
...
<h4>Param&egrave;tres</h4>
<ul>
<li>&#039;group&#039; - R&eacute;f&eacute;rence &agrave; l&#039;objet groupe concern&eacute;.s qu</p>
</ul>';
$lang['admin']['event_help_addstylesheetpre'] = '<p>Envoy&eacute; avant qu&#039;une nouvelle feuille de style soit cr&eacute;&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ul>
<li>&#039;stylesheet&#039; - R&eacute;f&eacute;rence &agrave; l&#039;objet feuille de style concern&eacute;</p>
</ul>
';
...
<li>&#039;type&#039; - Le type de d&#039;appel gabarit. Exemple : Gabarit pour un mod&egrave;le de gabarit, tpl_head, tpl_body, ou tpl_top pour un gabarit partiel.</li>
</ul>
';
$lang['admin']['event_help_templateprefetch'] = '<p>Envoy&eacute; avant qu&#039;un gabarit soit extrait de Smarty.
<h4>Param&egrave;tres</h4>
<ul>
...
<li>&#039;display&#039; (integer reference) - Indique si l&#039;entr&eacute;e est affich&eacute;e ou affect&eacute;e.</li>
<li>&#039;no_output_filter&#039; (integer reference) - Indique si les filtres de sortie doivent &ecirc;tre appliqu&eacute;s.</li>
</ul>
';
...
<h4>Param&egrave;tres</h4>
<ul>
<li>&#039;content&#039; - R&eacute;f&eacute;rence au texte de la feuille de style concern&eacute;e.content</li>
</ul>
';
...
$lang['admin']['backendwysiwygtouse'] = 'WYSIWYG par d&eacute;faut pour l&#039;administration (pour les nouveaux comptes utilisateurs)&nbsp;';
...
$lang['admin']['utma'] = '156861353.1805346427.1378658323.1378658323.1378658323.1';
$lang['admin']['utmc'] = '156861353';
$lang['admin']['utmz'] = '156861353.1378658323.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
