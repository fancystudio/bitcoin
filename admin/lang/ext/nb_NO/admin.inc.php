...
$lang['admin']['error_timedifference'] = 'Filesystemtid er ulik server tid';
$lang['admin']['server_time_diff'] = 'Test for tidsdifferanser i filsystemet';
$lang['admin']['tz_offset'] = 'Tidssone forskyvning';
$lang['admin']['gcb_name_help'] = '(kan kun inneholde bokstaver og tall)';
$lang['admin']['pagedefaultsupdated'] = 'Side for standardinstillinger ble oppdatert';
$lang['admin']['help_function_module_available'] = '<h3> Hva gj&oslash;r denne?</h3>
<p>Dette er en plugin for &aring; teste om en gitt modul (ved navn) er installert, og tilgjengelig for bruk. </p>
<h3>Hvilke parametere tar denne?</h3>
<ul>
<li><strong>(p&aring;krevd)modul</strong> - (string) Navnet p&aring; modulen</li>
...
$lang['admin']['module_param_lang'] = '<strong>Utg&aring;ende</strong> - Overstyr n&aring;v&aelig;rende spr&aring;k som er satt for &aring; velge oversatte strenger.';
$lang['admin']['server_db_grants'] = 'Test database tilgangsniv&aring;';
$lang['admin']['error_nograntall_found'] = 'Kunne ikke finne en passende &quot;GRANT ALL&quot; tillatelse. Dette kan bety at du kan f&aring; problemer med &aring; installere eller fjerne moduler. Eller til og med legge til eller slette enheter, inkludert sider';
$lang['admin']['msg_grantall_found'] = 'Fant et &quot;GRANT ALL&quot;-uttrykk som ser ut til &aring; passe';
...
$lang['admin']['sysmain_confirmupdateurls'] = 'Er du sikker p&aring; at du vil oppfriske rutedatabasen';
$lang['admin']['routesrebuilt'] = 'Database rutene er gjenoppbygd';
...
$lang['admin']['info_smarty_cacheudt'] = 'Hvis aktivert vil alle kall til brukerdefinerte tagger bli mellomlagret. Dette vil v&aelig;re nyttig for tagger som viser utdata av databasesp&oslash;rringer. Du kan deaktivere mellomlagring ved &aring; benytte en nocache parameter i UDT kallet. F.eks.: <code> {myusertag nocache}</code>';
...
$lang['admin']['info_smarty_cachemodules'] = 'Velg hvordan du vil mellomlagre tagger i ulike maler som kaller modulhandlinger. Om aktivert vil alle modulkall mellomlagres. Dette kan ha negative effekter p&aring; enkelte moduler, eller moduler med skjemaer. <em> (Merk: Du kan overstyre dette ved hjelp av nocachealternativet som beskrevet i smartymanualen) </em>. Hvis dette er deaktivert vil ingen modulkall bli mellomlagret, noe som kan ha en effekt p&aring; ytelsen. Hvis du velger &aring; tillate modulen til &aring; bestemme, er standard at mellomlagring ikke blir utf&oslash;rt. Modulen kan overstyre dette, og du kan deaktivere mellomlagring bruker nocache parameter n&aring;r du kaller opp modulen.';
$lang['admin']['prompt_smarty_cachemodules'] = 'Mellomlagre modulkall';
$lang['admin']['info_smarty_compilecheck'] = 'Hvis det er deaktivert vil ikke smarty sjekke modifikasjonsdatoene for maler for &aring; se om de har blitt modifisert. Dette kan forbedre ytelsen mye, men utf&oslash;rer man en forandring p&aring; en mal (eller til og med noen endringer i innholdet) kan dette kreve en mellomlagert&oslash;mming';
$lang['admin']['prompt_smarty_compilecheck'] = 'Gj&oslash;r en kompileringstest';
$lang['admin']['info_smarty_options'] = 'F&oslash;lgende alternativer har bare virkning n&aring;r overst&aring;ende alternativer for hurtigbufring er aktivert';
$lang['admin']['info_smarty_caching2'] = 'N&aring;r dette er aktivert, vil produksjonen fra ulike plugins bli lagret for &aring; &oslash;ke ytelsen. Dette gjelder bare ut p&aring; innholdssider merket som cachable, og bare for ikke-administrative brukere. Merk: Denne funksjonaliteten kan forstyrre oppf&oslash;rselen til enkelte moduler eller plugins, eller plugins som bruker ikke-inline former. Dette alternativet har ingen effekt for brukere av PHP 5.2.x';
$lang['admin']['prompt_use_smartycaching'] = 'Aktiver Smartymellomlagring';
$lang['admin']['smarty_settings'] = 'Smartyinnstillinger';
$lang['admin']['help_function_cms_init_editor'] = '<h3> Hva gj&oslash;r dette? </h3>
  <p> Dette programtillegget brukes til &aring; initialisere valgt WYSIWYG-editor for visning n&aring;r WYSIWYG-funksjonalitet er n&oslash;dvendig for innsending av data i frontend. Denne modulen vil finne den valgte frontend wysiwyg, avgj&oslash;re om den har blitt forespurt, og genererer eventuelt den aktuelle html-kode <em>(vanligvis javascriptlenker)</em> slik at wysiwyg vil starte skikkelig n&aring;r siden er lastet. Hvis ingen WYSIWYG-editor har blitt forespurt for frontendforesp&oslash;rselen, vil ikke dette programtillegget generere noe output. </p>
...
<p>Det f&oslash;rste du m&aring; gj&oslash;re er &aring; velge  hvilken WYSIWYG-editor som skal brukes i frontend. Dette gj&oslash;res i &#039;globale innstillinger&#039;-siden i adminpanelet. Neste steg, hvis du bruker frontend WYSIWYG-editor p&aring; mange sider, kan det v&aelig;re best &aring; plassere {cms_init_editor}-plugin direkte i din sidemal. Hvis du bare &oslash;nsker at WYSIWYG-editoren skal v&aelig;re aktivert p&aring; et begrenset antall sider, kan du bare plassere den i &quot;Sidespesifikke Metadata&quot;-feltet p&aring; hver enkelt side.</p>
<h3>Hvilke parametere tar programtillegget?</h3>
<ul>
<li><em>(valgfritt) wysiwyg </em> - Angi navnet p&aring; WYSIWYG-editormodulen som skal initialiseres. Brukes med forsiktighet. Hvis du har en annen WYSIWYG-editor valgt i de globale innstillingene, vil dette tvinge den spesifiserte editor &aring; bli initialisert.</li>
...
$lang['admin']['info_disallowed_contenttypes'] = 'Velg hvilke innholdstyper &aring; fjerne fra &quot;innholdstype&quot;-dropdown n&aring;r du redigerer eller legger til innhold. Bruk CTRL+klikk for &aring; velge eller velge bort elementer. Om ingen elementer er valgt vil dette indikere at alle innholdstyper er tillatt';
...
$lang['admin']['info_umask'] = '&quot;umask&quot; er en oktal verdi som brukes til &aring; angi standard tillatelse til nyopprettede filer (dette er brukt for filer i cache-katalogen, og for opplastede filer. For mer informasjon, se <a href="http://en.wikipedia.org/wiki/umask">Wikipedia-artikkelen. </a>';
...
$lang['admin']['event_desc_stylesheetprecompile'] = 'Sendes f&oslash;r et silark er behandlet med smarty';
...
$lang['admin']['info_browser_cache_expiry'] = 'Spesifiser hvor lenge (i minutter) som nettlesere kan mellomlagre sider. &Aring; sette denne verdi til 0 deaktiverer funksjonen';
...
$lang['admin']['help_function_browser_lang'] = '<h3>Hva gj&oslash;r denne?</h3>
  <p>Denne plugin oppdager og skriver ut det spr&aring;ket som brukerens nettleser aksepterer, og kryssrefererer det med en liste med tillatte spr&aring;k for &aring; avgj&oslash;re en spr&aring;kverdi for sesjonen.</p>
<h3>Hvordan bruker jeg denne?</h3>
<p>Sett inn taggen tidlig i din sidemal <em>(den kan st&aring; overfor <head> seksjonen om du &oslash;nsker dette)</em> og sett inn navnet p&aring; standardspr&aring;ket i taggen, og deretter de aksepterte spr&aring;kene (kun tobokstavs spr&aring;knavn er godtatt), deretter gj&oslash;r du noe med resultatet.  F.eks.:</p>
...
<h3>Hvilke parametere tar denne?</h3>
<ul>
<li><strong>accepted <em>(required)</em></strong><br/> - En kommaseparert liste med tostavelse spr&aring;knavn som er aksepterte.</li>
<li>default<br/>- <em>(optional)</em> Et standard spr&aring;k som skal vises om ingen aksepterte spr&aring;k var st&oslash;ttet av nettleseren.  en er benyttet om ingen annen verdi er oppgitt.</li>
<li>assign<br/>- <em>(optional)</em> Navnet p&aring; smarty-variabelen resultatet tilegnes. Om dette ikke er oppgitt vil resultatet av denne funksjonen blir returnert.</li>
</ul>';
$lang['admin']['info_target'] = 'Dette valget kan benyttes av Menu Manager for &aring; indikere n&aring;r og hvordan nye rammer eller vinduer skal &aring;pnes. Noen menybehandlermaler vil muligens ignorere dette valget.';
$lang['admin']['close'] = 'Lukk';
$lang['admin']['open'] = '&Aring;pne';
...
$lang['admin']['content_mandatory_urls'] = 'Side-URL&#039;er er p&aring;krevd';
...
$lang['admin']['help_page_url'] = 'Angi en alternativ URL (relativt til roten p&aring; ditt nettsted) som kan brukes for &aring; identifisere denne siden. i.e: sti/til/minside Side-URL&#039;en er kun nyttig n&aring;r vakre URL&#039;er er p&aring;sl&aring;tt.';
...
$lang['admin']['invalid_url2'] = 'Sidens URL er ugyldig. Den skal kun inneholde alfanumeriske tegn, eller - eller /. Endelsen skal bare inneholde alfanumeriske tegn og v&aelig;re mindre enn 5 tegn langt. Det er ogs&aring; mulig at URL&#039;en du har angitt allerede er i bruk.';
$lang['admin']['page_url'] = 'Sidens URL';
$lang['admin']['runuserplugin'] = 'Kj&oslash;r brukerplugin';
...
$lang['admin']['ecommerce_desc'] = 'Moduler for &aring; tilf&oslash;re e-handelegenskaper';
...
<p>Parametere:
  <ul>
  <li><strong>(p&aring;krevd)</strong>modul - Navnet p&aring; modulen som vil gi denne innholdsblokken. Denne modulen m&aring; v&aelig;re installert og tilgjengelig </li>
  <li><strong>(p&aring;krevd)</strong>block -. Navnet p&aring; innholdsblokken</li>
  <li><em>(valgfritt)</em>label - En etikett for innholdet blokken for bruk n&aring;r du redigerer siden </li>
  <li><em>(valgfritt)</em>tab - &Oslash;nsket fane for &aring; vise dette feltet p&aring; i redigeringskjema .. </li>
...
$lang['admin']['thumbnail_height'] = 'Miniatyrbildets h&oslash;yde';
...
$lang['admin']['info_deletepages'] = 'Merk: Vrunnet tilgangsrestriksjoner kan noen sidene du valgte for sletting v&aelig;re utelatt fra listen nedenfor';
...
$lang['admin']['enablenotifications'] = 'Sl&aring; p&aring; brukervarsler i administrasjonsseksjonen.';
$lang['admin']['test_check_open_basedir_failed'] = 'Open basedir-restriksjoner er aktive. Du kan f&aring;r problemer med noe tilleggfunksjonalitet med denne restriksjonen.';
...
$lang['admin']['warning_upgrade_info1'] = 'Du kj&oslash;rer n&aring; databaseskjema versjon %s. og du trenger &aring; oppgradere til versjon %s';
...
$lang['admin']['copy_paste_forum'] = 'Klikk her for &aring; lime inn i et foruminnlegg';
...
$lang['admin']['max_execution_time'] = 'Maksimum utf&oslash;relsestid';
...
$lang['admin']['systemmaintenancedescription'] = 'Ulike funksjoner for &aring; opprettholde helsen til systemet ditt. Du kan ogs&aring; lese endringsloggen for CMSMadeSimple';
...
$lang['admin']['sysmain_updatehierarchy'] = 'Oppdater sidehierarkiets rekkef&oslash;lge';
$lang['admin']['sysmain_confirmupdatehierarchy'] = 'Er du sikker p&aring; at du vil oppdatere side-hierarki posisjonene?';
$lang['admin']['sysmain_update'] = 'Oppdater';
$lang['admin']['sysmain_pagesfound'] = 'sider funnet';
$lang['admin']['sysmain_hierarchyupdated'] = 'Sidehierarkiets rekkef&oslash;lge ble oppdatert';
...
$lang['admin']['sysmain_confirmclearcache'] = 'Er du sikker p&aring; at du vil t&oslash;mme mellomlageret?';
...
$lang['admin']['sysmain_confirmfixaliases'] = 'Er du sikker p&aring; at du vil legge til alias til sider som mangler dette?';
...
$lang['admin']['sysmain_confirmfixtypes'] = 'Er du sikker p&aring; at du vil konvertere alle med ugyldig innholdstype til standard innholdsider?';
...
<h3>Hvordan bruker jeg denne?</h3>
	...
	<h3>Hvilke parametere tar denne?</h3>
        <p><em>(valgfri)autossl=1</em> - P&aring;sl&aring;tt som standard, dette valget wil oppdage og om sp&oslash;rringen til serveren var over SSL, og om det var det s&aring; vil passende konfigurert SSL url gis. For &aring; sl&aring; av denne egenskapen s&aring; angir du autossl=0.</p>
...
$lang['admin']['help_function_breadcrumbs'] = '<h3>style=&quot;font-weight:bold;color:#f00;&quot;>FORELDET Benytt [cms_breadcrumbs] fra n&aring;!</h3>
<h3>Hva gj&oslash;r denne?</h3>
...
$lang['admin']['content_id'] = 'InnholdsID';
...
$lang['admin']['submit'] = 'Lagre og lukk';
...
$lang['admin']['lang_settings_legend'] = 'Spr&aring;krelaterte innstillinger';
$lang['admin']['content_editor_legend'] = 'Innholdsredigerer innstillinger';
$lang['admin']['admin_layout_legend'] = 'Admin utseende innstillinger';
...
$lang['admin']['media_query'] = 'Mediasp&oslash;rring';
$lang['admin']['media_query_description'] = '<strong>Merk:</strong> N&aring;r mediasp&oslash;rring er benyttet, vil Mediatype valget bli ignorert.<br /> Benytt ethvert gyldig uttrykk som anbefalt av <a href="http://www.w3.org/TR/css3-mediaqueries/" rel="_blank" title="W3C">W3C</a>.';
...
$lang['admin']['event_desc_templateprefetch'] = 'Sendt f&oslash;r en mal er hentet av smarty';
...
<li>&#039;type&#039; - Type mal kall. f.eks.: mal for en hel mal, tpl_head, tpl_body eller tpl_top for en delvis mal</li>
</ul>';
$lang['admin']['event_help_templateprefetch'] = '<p>Sendt f&oslash;r en mal er hentet av smarty.
<h4>Parametere</h4>
<ul>
<li>&#039;template&#039; (string referanse) - Navnet p&aring; malen.</li>
...
<li>&#039;display&#039; (heltall referanse) - Indikerer om produksjonen blir vist eller overdras</li>
...
$lang['admin']['utma'] = '156861353.793561001.1377811834.1378677756.1378746753.28';
$lang['admin']['utmz'] = '156861353.1377811834.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)';
