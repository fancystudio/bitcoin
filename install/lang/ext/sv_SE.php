...
$lang['docroot_leaveblank'] = 'L&auml;mna f&auml;ltet tomt f&ouml;r att anv&auml;nda systemets standard';
$lang['test_xmlreader_class'] = 'Kontrollerar om XMLReader class existerar';
$lang['test_xmlreader_failed'] = 'The XMLReader class &auml;r inte tillg&auml;ngligt i din php installation.  Du kan fortfarande anv&auml;nda systemet men kommer inte att kunna anv&auml;nda n&aring;gon av de avl&auml;gsna funktionerna modulinstallation.';
...
$lang['install_admin_pwsalt_note'] = 'Om du v&auml;ljer att anv&auml;nda saltade l&ouml;senord s&aring; finns det ingen m&ouml;jlighet att &aring;terst&auml;lla administrat&ouml;rsl&ouml;senord f&ouml;rutom via gl&ouml;mt-l&ouml;senords-funktionen. Det &auml;r d&auml;rf&ouml;r n&ouml;dv&auml;ndigt att du anger en epost-adress till varje administrat&ouml;rskonto.';
$lang['admin_salt'] = 'Anv&auml;nd saltade administrat&ouml;rsl&ouml;senord';
$lang['setup_flat_urls'] = 'Flat URLs &auml;r aktiverat';
$lang['install_timezone'] = 'Vissa servrar som k&ouml;r med PHP 5.3 har inte r&auml;tt tidszon inst&auml;lld. V&auml;lj r&auml;tt tidszon i listan nedan. Om detta inte &auml;r n&ouml;dv&auml;ndigt p&aring; din server kan du v&auml;lja &quot;Ingen&quot; <strong>Observera:</strong> Detta &auml;r inte enbart en inst&auml;llning som ber&ouml;r visning av datum utan p&aring;verkar &auml;ven alla ber&auml;kningar som inneh&aring;ller datum. Det &auml;r d&auml;rf&ouml;r rekomenderat att ange din servers tidszon. Denna inst&auml;llning kan &auml;ndras efter installationen genom att redigera i config.php.';
