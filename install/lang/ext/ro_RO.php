<?php
$lang['installed_module'] = 'Modul instalat';
$lang['automatedtask_success'] = 'Task automat reusit';
$lang['ip_addr'] = 'Adresa IP';
$lang['install_admin_pwsalt_note'] = 'Daca doriti sa activati &quot;sararea&quot; parolelor, nu este nicio modalitate de resetare a parolelor de admin uitate, in afara de functionalitatea de recuperare parola. Este critica asocierea unei adrese de e-mail cu fiecare cont de admin.';
$lang['admin_salt'] = 'Sarare parole de admin';
$lang['setup_flat_urls'] = 'URL-urile plate au fost setate';
$lang['install_timezone'] = 'Unele servere cu PHP 5.3 nu au fusul orar setat corect. Selectati fusul orar corect din lista de mai jos inainte de a continua. Daca nu este necesar pentru serverul dumneavoatra, puteti selecta &quot;Nimic&quot;. <strong>Nota:</strong> Selectati fusul orar pentru server, aceasta nu este o setare de afisare, ci una pentru calculele legate de date. Aceasta setare poate fi modificata dupa instalare modificand fisierul config.php.';
