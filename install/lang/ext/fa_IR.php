...
$lang['install_admin_docroot_path'] = 'پوشه اصلی برنامه';
$lang['install_admin_querystring'] = 'Query string (leave this alone unless you have trouble, then edit config.php by hand)';
$lang['invalid_querys'] = '<b>اخطار</b> : درخواست&zwnj;های غیر معتبر در پایگاه داده شما';
...
$lang['install_admin_set_core_event'] = 'در حال نصب هسته اصلی ... .';
$lang['install_admin_install_modules'] = 'در حال نصب ماژول&zwnj;ها ... .';
$lang['install_admin_index_search'] = 'Index Search...';
$lang['install_admin_clear_cache'] = 'در حال حذف کردن ذخیره&zwnj;ساز خودکار (یعنی اگر هیچ چیزی موجود نیست!) ... .';
$lang['install_admin_emailing'] = 'در حال ارسال اطلاعات مدیریتی به پست الکترونیک ... .';
$lang['install_admin_congratulations'] = 'موفق شدید ! شما نصب کننده را به خوبی راهنمایی کردید. - اکنون شما اینجا هستید';
$lang['could_not_connect_db'] = 'عدم دسترسی به پایگاه داده ! بررسی کنید شناسه پایگاه داده و یا رمز عبور را صحیح وارد نمودید ؟ و همچنین برای شناسه دسترسی کافی را مشخص نموده&zwnj;اید تا به پایگاه داده شما متصل شود ؟';
$lang['cannot_write_config'] = 'خطا:حق نوشتن در %s صادر نشده است !';
$lang['email_accountinfo_subject'] = 'اطلاعات مدیریتی ساده نویس';
$lang['email_accountinfo_message'] = 'سپاسگذاریم که از ساده نویس (Made Simple) استفاده می&zwnj;کنید.

این اطلاعات را برای ورود به سیستم مدیریتی به خاطر بسپارید :
شناسه مدیریتی : %s
رمز عبور : %s

ورود به درگاه مدیریتی را از اینجا تجربه کنید : %s';
$lang['utma'] = '156861353.1666476991.1321789874.1323033020.1324408708.4';
$lang['utmz'] = '156861353.1321789874.1.1.utmcsr=dev.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/projects/cmsms-persian';
$lang['qca'] = 'P0-2141618195-1322221016416';
$lang['utmb'] = '156861353.4.10.1324408708';
$lang['utmc'] = '156861353';
?>