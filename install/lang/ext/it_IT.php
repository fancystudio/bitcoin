<?php
$lang['error_timedifference'] = 'Il file system in cui &egrave; installato CMSMS ha un tempo significativamente diverso rispetto al tempo effettivo del server';
$lang['test_timedifference'] = 'Verifico se l&#039;ora del filesystem &egrave; diversa dall&#039;ora del server';
...
$lang['test_xmlreader_class'] = 'Verifico l&#039;esistenza della classe XMLRreader';
$lang['test_xmlreader_failed'] = 'La classe XMLReader non &egrave; abilitata nella vostra installazione php.  Potete ancora utilizzare il sistema ma non sarete in grado di utilizzare alcuna delle funzioni di installazione remota dei moduli.';
$lang['test_check_xml_failed'] = 'Il supporto XML non &egrave; compilato nella vostra installazione PHP. Potete ancora utilizzare il sistema, ma non riuscirete a sfruttare alcuna delle funzionalit&agrave; di installazione remota dei moduli.';
...
$lang['install_please_read'] = 'Vi invitiamo a leggere la pagina sulle <a rel="external" href="http://docs.cmsmadesimple.org/installation/requirements">Problematiche di Installazione</a> nella documentazione di CMS Made Simple Documentation Wiki.';
