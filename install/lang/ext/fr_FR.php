<?php
$lang['error_timedifference'] = 'Le syst&egrave;me de fichiers o&ugrave; CMSMS est install&eacute; a une date significativement diff&eacute;rente de celle r&eacute;elle du serveur';
$lang['test_timedifference'] = 'Test du syst&egrave;me de fichiers si diff&eacute;rent du serveur';
$lang['detected'] = 'D&eacute;tect&eacute;';
$lang['docroot_leaveblank'] = 'Laissez ce champ vide pour utiliser la valeur par d&eacute;faut';
$lang['test_xmlreader_class'] = 'V&eacute;rification si la classe XMLReader existe';
$lang['test_xmlreader_failed'] = 'La classe XMLReader n&#039;est pas activ&eacute;e dans votre installation de PHP. Vous pouvez toujours utiliser le syst&egrave;me, mais ne serez pas en mesure d&#039;utiliser les fonctions du Gestionnaire de Modules.';
...
$lang['install_admin_pwsalt_note'] = 'Si vous choisissez d&#039;activer &quot;Mots de passe Admin s&eacute;curis&eacute;s&quot;, il n&#039;y a absolument aucun moyen de r&eacute;initialiser les mots de passe Admin perdus autrement que par la fonctionnalit&eacute; de r&eacute;cup&eacute;ration du mot de passe sur la page de connexion administration. Il est essentiel que vous associez donc une adresse email &agrave; chaque compte Admin pour recevoir par courrier &eacute;lectronique ce nouveau mot de passe.';
$lang['admin_salt'] = 'Mots&nbsp;de&nbsp;passe&nbsp;Admin&nbsp;s&eacute;curis&eacute;s';
$lang['setup_flat_urls'] = 'URL courtes en service';
$lang['install_timezone2'] = 'Merci de choisir le fuseau horaire pour votre installation. Cette valeur de fuseau horaire sera utilis&eacute; pour pour les calculs des dates et heures.<br/>CMSMS a tent&eacute; de choisir un fuseau horaire par d&eacute;faut pour vous en fonction de votre serveur actuel, mais cela peut ne pas &ecirc;tre correct. <br/><strong style=&quot;color: red;&quot;>Note :</strong> Il s&#039;agit d&#039;un changement de comportement par rapport aux versions pr&eacute;c&eacute;dentes de CMSMS. En outre, vous devrez peut-&ecirc;tre activer la valeur de config set_db_timezone si votre serveur est dans un autre fuseau horaire que celui contenu dans la base d&#039;utilisateurs primaire';
...
$lang['install_admin_frontendlang'] = 'Langue par d&eacute;faut pour l&#039;interface publique. Locale &agrave; utiliser par d&eacute;faut pour diverses fonctions de manipulation de la date, etc... Laissez ce champ vide pour un environnement multilingue ou utilisez les valeurs par d&eacute;faut du serveur';
$lang['install_default_encoding'] = 'Dans presque tous les cas, utf-8 devrait &ecirc;tre l&#039;encodage. Si vous vous voulez un encodage diff&eacute;rent, changez-le ici, mais gardez cependant &agrave; l&#039;esprit que toutes les traductions de langues sont en utf-8';
...
$lang['install_test_checksum'] = 'Vous pouvez valider l&#039;int&eacute;grit&eacute; de vos fichiers CMSMS&trade; en les comparant avec le fichier de contr&ocirc;le (cmsmadesimple-x.x.x-xxxx-checksum.dat). Il peut vous aider &agrave; trouver des probl&egrave;mes sur le transfert des fichiers.';
...
$lang['install_please_read'] = 'Merci de lire <a rel="external" href="http://docs.cmsmadesimple.org/installation/requirements">Requirements</a> de la page en anglais &quot;Official Documentation&quot; de CMS Made Simple&trade;.';
...
$lang['install_value_passed'] = 'Test pass&eacute;';
$lang['install_value_failed'] = 'Test &eacute;chou&eacute;';
...
$lang['install_value_recommended'] = 'Configuration au-dessus de la valeur exig&eacute;e, mais en-dessous de la valeur recommand&eacute;e<br />ou... La configuration qui <em>peut</em> &ecirc;tre exig&eacute;e pour certaines fonctionnalit&eacute;s facultatives est indisponible';
$lang['install_value_exceed'] = 'Configuration OK ou sup&eacute;rieure au seuil recommand&eacute;<br />ou... La configuration qui peut &ecirc;tre <em>exig&eacute;e</em> pour certaines fonctionnalit&eacute;s facultatives est disponible';
$lang['install_test_failed'] = 'Un ou plusieurs essais ont &eacute;chou&eacute; ou sont en alerte. Vous pouvez installer le syst&egrave;me mais quelques fonctions peuvent ne pas fonctionner correctement.<br />Refaire un essai pour corriger la situation et cliquer sur &quot;Nouvel essai&quot;, ou sur le bouton &quot;Continuer&quot; si les valeurs sont au minimum de la &quot;Configuration recommand&eacute;e&quot; seulement.';
...
$lang['install_admin_umask'] = 'Test de masque de cr&eacute;ation de fichier';
...
$lang['test_email_accountinfo'] = 'L&#039;envoi d&#039;un email d&#039;informations a &eacute;t&eacute; s&eacute;lectionn&eacute;, mais aucune adresse email n&#039;a &eacute;t&eacute; renseign&eacute;e !';
...
$lang['test_check_php'] = 'V&eacute;rification de la version de PHP %s+';
...
$lang['install_admin_db'] = 'Informations sur la base de donn&eacute;es';
$lang['install_admin_db_info'] = '<p>Votre site sous CMS Made Simple&trade; n&eacute;cessite une base de donn&eacute;es pour fonctionner. Avant de poursuivre l&#039;installation, assurez-vous que votre base de donn&eacute;es a &eacute;t&eacute; cr&eacute;&eacute;e et qu&#039;un utilisateur disposant de tous les privil&egrave;ges sur cette base existe.</p>
<p><strong>Vous pouvez utiliser un programme comme PhpMyAdmin ou le panneau d&#039;administration de votre h&eacute;bergement pour g&eacute;rer votre base de donn&eacute;es.</strong></p>
<p><strong>Pour MySQL, vous pouvez aussi taper les commandes suivantes dans une console :</strong><br />
- create database cms; 
(utilisez le nom que vous voulez pour la base - ici &quot;cms&quot; -, sauf contrainte li&eacute;e &agrave; votre h&eacute;bergeur, et retenez son nom exact car vous devrez le saisir ci-dessous)<br />
...
$lang['install_admin_querystring'] = 'Symbole apr&egrave;s &quot;index.php?&quot; (exemple. http://www.monsite.fr/index.php?page=xxx ). Laissez tel quel et &eacute;ditez &eacute;ventuellement le fichier config.php &agrave; la main';
...
$lang['install_admin_emailing'] = 'Email d&#039;information sur le compte Administrateur envoy&eacute; ...&nbsp;';
...
$lang['utma'] = '156861353.1805346427.1378658323.1378658323.1378658323.1';
$lang['utmc'] = '156861353';
$lang['utmz'] = '156861353.1378658323.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
$lang['utmb'] = '156861353';
?>