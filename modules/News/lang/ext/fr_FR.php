<?php
$lang['error_nooptions'] = 'Pas options sp&eacute;cifi&eacute;es pour la d&eacute;finition du champ';
$lang['dropdown'] = 'Liste d&eacute;roulante';
$lang['info_public'] = 'Les champs publiques ne sont pas disponibles pour l&#039;&eacute;dition sur le site (frontend), ou pour l&#039;affichage du r&eacute;sum&eacute; ou du d&eacute;tail. Ils sont utiles pour les donn&eacute;es qui sont associ&eacute;es &agrave; l&#039;article, mais pas pour l&#039;usage publique.';
$lang['info_expired_viewable'] = 'Si activ&eacute;e, les articles p&eacute;rim&eacute;s peuvent &ecirc;tre visualis&eacute;es en mode d&eacute;tail (ce qui est l&#039;ancienne fonctionnalit&eacute;). Le param&egrave;tre showall peut &ecirc;tre utilis&eacute; avec l&#039;URL (si vous n&#039;utilisez pas les pretty URLs jolies)pour indiquer &eacute;galement que les articles p&eacute;rim&eacute;s peuvent &ecirc;tre consult&eacute;s.';
$lang['expired_viewable'] = 'Articles expir&eacute;s peuvant &ecirc;tre consult&eacute;s dans la vue de d&eacute;tail';
$lang['error_insufficientparams'] = 'Param&egrave;tres insuffisant (ou vide)';
$lang['error_duplicatename'] = 'Un &eacute;l&eacute;ment avec ce nom existe d&eacute;j&agrave;';
$lang['detail_page'] = 'Page de d&eacute;tail&nbsp;';
$lang['detail_template'] = 'Gabarit du d&eacute;tail&nbsp;';
$lang['warning_preview'] = 'Attention : cette page d&#039;aper&ccedil;u se comporte comme une fen&ecirc;tre permettant de naviguer loin de cette page aper&ccedil;u originale. Toutefois, si vous faites cela, attention aux comportements inattendus ! <strong>Note :</strong> La pr&eacute;visualisation ne tient pas compte des fichiers pouvant &ecirc;tre en attente d&#039;upload.';
...
$lang['approve'] = 'Mettre le statut &agrave; &#039;Publi&eacute;&#039;';
$lang['revert'] = 'Mettre le statut &agrave; &#039;&Eacute;bauche&#039;';
...
$lang['info_sysdefault'] = '(le gabarit utilis&eacute; par d&eacute;faut quand un nouveau gabarit est s&eacute;lectionn&eacute;)';
...
<p><strong>Note :</strong> Tous les param&egrave;tres peuvent ne pas &ecirc;tre pr&eacute;sents lorsque cet &eacute;v&eacute;nement est envoy&eacute;..</p>';
...
<li>&quot;fesubmit&quot; - <strong>Obsol&egrave;te</strong>pour afficher le gabarit de soumission (frontend) d&#039;articles des utilisateurs dans les pages du site. Ajouter le <code>{cms_init_editor}</code> dans la section des m&eacute;ta-donn&eacute;es pour initialiser l&#039;&eacute;diteur WYSIWYG s&eacute;lectionn&eacute; (Administration du site/Param&egrave;tres globaux/WYSIWYG de la partie publique).</li>
