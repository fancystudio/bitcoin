...
$lang['info_expired_viewable'] = 'Hvis aktivert, kan utg&aring;tte artikler vises i detalj modus (dette er tilsvarende det fungerte f&oslash;r). Showall parameteren kan brukes p&aring; URLen (n&aring;r du ikke bruker vakre urler) til ogs&aring; &aring; indikere at utg&aring;tte artikler kan sees';
$lang['expired_viewable'] = 'Utg&aring;tte artikler kan vises i detaljmodus';
...
$lang['warning_preview'] = 'Advarsel: Denne forh&aring;ndsvisningen panel oppf&oslash;rer seg omtrent som et nettleservindu der du kan navigere bort fra den opprinnelig forh&aring;ndsvises siden. Men hvis du gj&oslash;r det, kan det hende du opplever uventet oppf&oslash;rsel. Navigere bort fra den f&oslash;rste siden og tilbake vil ikke gi de forventede resultatene<br/><strong>. Merknad:</strong> Forh&aring;ndsvisningen vil ikke laste opp filer du kanskje har valgt for opplasting.';
...
<p><strong>Merk:</strong> Ikke alle parametere vill v&aelig;re tilgjengelige n&aring;r denne handlingen blir sendt.</p>';
...
<li>&quot;fesubmit&quot; - for &aring; vise et forside skjema for &aring; tillate brukere &aring; bidra med nyhetsartikler fra nettsiden. Legg til <code>{cms_init_editor}</code> taggen i metadataseksjonen for &aring; initialisere den valgte wysiwyg-redigereren. (Nettstedsadmin  > > Globale innstillinger)</li>
...
$lang['utma'] = '156861353.793561001.1377811834.1378410870.1378491430.20';
$lang['utmz'] = '156861353.1377811834.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)';
$lang['utmb'] = '156861353.2.10.1378491430';
$lang['utmc'] = '156861353';
?>