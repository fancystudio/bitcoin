...
$tiny=$gCms->GetModuleInstance("TinyMCE");
...
$stripbackground = $tiny->GetPreference("striptags","true");
...
$bodycss = $tiny->GetPreference("bodycss");
...
if ($tiny->GetPreference("loadstylesheet","1")!="1") $css="";

$extrastyles=$tiny->GetPreference("extrastyles","li {\n  margin-left : 16px;\n}");
