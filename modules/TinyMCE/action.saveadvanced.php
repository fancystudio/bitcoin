...
if (isset($params['usehtml5scheme']))
  $this->SetPreference('usehtml5scheme', 1);
else
...
if (isset($params['skinvariation']))
  $this->SetPreference('skinvariation', $params['skinvariation']);

if (isset($params['entityencoding']))
  $this->SetPreference('entityencoding', $params['entityencoding']);

if (isset($params['extraconfig']))
  $this->SetPreference('extraconfig', $params['extraconfig']);

if (isset($params['customdropdown']))
  $this->SetPreference('customdropdown', $params['customdropdown']);

if (isset($params['extrastyles']))
  $this->SetPreference('extrastyles', $params['extrastyles']);
...
if (isset($params['avoidlinkconversion']))
  $this->SetPreference('avoidlinkconversion', 1);
else
  $this->SetPreference('avoidlinkconversion', 0);
...
if (isset($params['cmslinkerstyle']))
  $this->SetPreference('cmslinkerstyle', $params['cmslinkerstyle']);

if (isset($params['cmslinkeradds']))
  $this->SetPreference('cmslinkeradds', $params['cmslinkeradds']);
...
if (isset($params['bodycss']))
  $this->SetPreference('bodycss', $params['bodycss']);
...
if (isset($params['dropdownblockformats']))
  $this->SetPreference('dropdownblockformats', $params['dropdownblockformats']);
