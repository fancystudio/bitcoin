...
$usehtml5scheme = $this->GetPreference('usehtml5scheme',0);

$cmslinkerstyle = $this->GetPreference('cmslinkerstyle',"selflink");
$cmslinkeradds = $this->GetPreference('cmslinkeradds',"");

$avoidlinkconversion = $this->GetPreference("avoidlinkconversion","0");
...
$this->smarty->assign('cmslinkerstyle_input',$this->CreateInputDropdown($id,"cmslinkerstyle",
									array($this->Lang("cmsselflinkstyle")=>"selflink",$this->Lang("ahrefstyle")=>"a"),
									-1,$cmslinkerstyle));
$this->smarty->assign('cmslinkeradds_input', $this->CreateInputText($id, 'cmslinkeradds',$cmslinkeradds, 20));
$this->smarty->assign('cmslinkeradds_text', $this->Lang('cmslinkeraddstext'));
$this->smarty->assign('cmslinkeradds_help', $this->Lang('cmslinkeraddshelp'));

$this->smarty->assign('avoidlinkconversion_input', $this->CreateInputCheckbox($id, 'avoidlinkconversion', "1", $avoidlinkconversion));
$this->smarty->assign('avoidlinkconversion_text', $this->Lang('avoidlinkconversiontext'));
$this->smarty->assign('avoidlinkconversion_help', $this->Lang('avoidlinkconversionhelp'));
...
$this->smarty->assign('usehtml5schemetext', $this->Lang('usehtml5schemetext'));
$this->smarty->assign('usehtml5schemeinput', $this->CreateInputCheckbox($id, 'usehtml5scheme', "1", $usehtml5scheme ));
