...
<ul>
  <li>default<em>(default)</em> - prednastaven&aacute;, zobrazuje menu</li>
  <li>breadcrumbs - zobrazuje drobečkov&uacute; navig&aacute;ciu  <strong>Pozn&aacute;mka: {cms_breadcrumbs}</strong> možete použiť aj t&uacute;to značku pre zobrazenie</li>
</ul>';
$lang['help_root'] = 'Aplikovateľn&eacute; iba pri použit&iacute; Breadcrumbs (drobečkov&aacute; navig&aacute;cia), povoľuje nastaviť začiatok navig&aacute;cia, pokiaľ to nie je prednastaven&aacute; str&aacute;nka';
$lang['youarehere'] = 'Navig&aacute;cia';
$lang['set_cachable'] = 'Nastaviť &scaron;abl&oacute;nu ako ke&scaron;ovateľn&uacute;';
