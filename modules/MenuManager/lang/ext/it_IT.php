<?php
$lang['help_action'] = 'Specificare il comportamento del modulo.  Ci sono due possibilit&agrave; per questo parametro:
<ul>
  <li>default <em>(default)</em> - Utilizzato per costruire un menu di navigazione.</li>
  <li>breadcrumbs - Utilizzato per creare l&#039;indicazione di percorso della pagina visualizzata.  <strong>Nota: {cms_breadcrumbs}</strong> &egrave; un&#039;abbreviazione per per richiamare questa azione.</li>
</ul>';
$lang['help_root'] = 'Applicabile solo all&#039;azione breadcrumbs, permette di specificare un livello di partenza che non sia la pagina predefinita.';
$lang['youarehere'] = 'Voi siete qui';
$lang['set_cachable'] = 'Imposta questo template come memorizzabile in cache';
$lang['help_nocache'] = 'Disabilita la memorizzazione in cache di questa chiamata al menu. Questo parametro, se impostato su un valore positivo, sovrascrive qualsiasi impostazione nell&#039;oggetto Contenuto e nel template del menu.';
$lang['cachable'] = 'Memorizzabile in cache';
$lang['help_childrenof'] = 'Con questa opzione il menu visualizzer&agrave; solo gli elementi di livello inferiore all&#039;ID di pagina o alias selezionato. Ad es.: <code>{menu childrenof=$page_alias}</code> visualizzer&agrave; solo le pagine figlio di quella corrente.';
$lang['usage'] = 'Utilizzo';
$lang['import'] = 'Importa';
$lang['edit'] = 'Modifica';
$lang['delete'] = 'Elimina';
$lang['help_loadprops'] = 'Utilizzate questo parametro quando NON state sfruttando propriet&agrave; avanzate nel vostro modello del gestore menu. Questo parametro disabiliter&agrave; il caricamento di tutte le propriet&agrave; di contenuto per ogni nodo (come extra1, imagine, miniatura, ecc.). Quest&#039;operazione diminuir&agrave; drasticamente il numero di query richieste per creare il menu e la memoria necessaria, ma inibir&agrave; la possibilit&agrave; di menu molto pi&ugrave; avanzati';
...
$lang['utma'] = '107768413.761460248.1357753980.1357753980.1357753980.1';
$lang['utmz'] = '107768413.1357753980.1.1.utmcsr=solgea.net|utmccn=(referral)|utmcmd=referral|utmcct=/cmsms/admin/editcontent.php';
?>