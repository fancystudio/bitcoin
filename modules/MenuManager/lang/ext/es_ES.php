<?php
$lang['help_action'] = 'Comportamiento del m&oacute;dulo. Existen dos posibilidades para este par&aacute;metro.
<ul>
  <li>default <em>(default)</em> - Usado para construir un menu de navegaci&oacute;n.</li>
  <li>breadcrumbs - Usado para construir un sendero de &#039;breadcrumbs&#039; (migas de pan) hacia la pagina mostrada.  <strong>Nota: {cms_breadcrumbs}</strong> is la forma corta de llamar a esta acci&oacute;n.</li>
</ul>';
$lang['help_root'] = 'Aplicable solo para la acci&oacute;n &#039;breadcrumbs&#039;, permite especificar el nivel de inicio, que no sea pagina for omisi&oacute;n.';
$lang['youarehere'] = 'Usted est&aacute; aqui';
$lang['set_cachable'] = 'Establecer esta plantilla como cacheable';
$lang['help_nocache'] = 'Desabilitar cache del menu. Este parametro anula cualquier ajuste en el contenido y de la plantilla del menu.';
$lang['cachable'] = 'Cacheable';
$lang['help_childrenof'] = 'Esta opcion hara que el menu muestre items que son descendientes del id de pagina or del alias seleccionado. Por ejemplo: <code>{menu childrenof=$page_alias}</code> solo mostrar&aacute; los descendientes de la pagina actual.';
$lang['usage'] = 'Uso';
