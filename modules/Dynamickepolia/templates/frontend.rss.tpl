...
<?xml-stylesheet title="XSL_formatting" type="text/xsl" href="/modules/Dynamickepolia/rss/style.xsl"?>
<rss version="2.0" >
	<channel>
		<title>Dynamickepolia RSS feed</title>
		<link>{$root_url}</link>
		<description>Dynamickepolia</description>
