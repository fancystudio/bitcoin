...
$form = new CMSForm('Dynamickepolia', $id,'edit',$returnid);
...
DynamickepoliaViews::createForm($this,$form,$item);
...
// SUB MODULES SECTION
$c = new MCFCriteria();
$c->add('parent_module', 1, MCFCriteria::EQUAL);
...
if (is_object($modulextender) && $modulextender->isXtendedModule($this->getName())) {  
  $this->smarty->assign('xtended_form', $modulextender->XtendModuleForm('Dynamickepolia', $item->getId(), $id));
} else {
