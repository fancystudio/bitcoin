...
if(isset($_SESSION['Dynamickepolia']['view']) && !isset($params['view']))
{
	$params['view'] = $_SESSION['Dynamickepolia']['view'];
}
...
echo DynamickepoliaViews::adminItems($this,$id,$returnid,$view,$items);	

$_SESSION['Dynamickepolia']['view'] = $view->getView();