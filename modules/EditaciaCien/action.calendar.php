...
{
  unset($_SESSION['modules']['EditaciaCien']['calendar']['scope']);
}
...
elseif(isset($_SESSION['modules']['EditaciaCien']['calendar']['scope']))
{
  $scope = $_SESSION['modules']['EditaciaCien']['calendar']['scope'];
}
else
{
  $scope = time();
...
if(!isset($params['forget_scope']))
{
  $_SESSION['modules']['EditaciaCien']['calendar']['scope'] = $scope;
}
