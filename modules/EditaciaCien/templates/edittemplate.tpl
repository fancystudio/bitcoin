...
<ul class="extra_fields" style="margin-left: 0; padding-left: 0;">
		<li><a href="#">$item->EUR_k_dispozci_na_nkup</a></li>
		<li><a href="#">$item->btc_k_dispozci_na_predaj</a></li>
		<li><a href="#">$item->mara_v_Percent_na_nkup</a></li>
		<li><a href="#">$item->mara_v_Percent_na_predaj</a></li>
	</ul>
