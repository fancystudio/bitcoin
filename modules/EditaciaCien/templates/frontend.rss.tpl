...
<?xml-stylesheet title="XSL_formatting" type="text/xsl" href="/modules/EditaciaCien/rss/style.xsl"?>
<rss version="2.0" >
	<channel>
		<title>EditaciaCien RSS feed</title>
		<link>{$root_url}</link>
		<description>EditaciaCien</description>
