...
$db = $this->GetDb();
if( $this->_HasSufficientPermissions('siteprefs') || $this->_HasSufficientPermissions('templates') ) {
...
if( $this->_HasSufficientPermissions('properties') ) {
  ...
  include(__DIR__.'/function.admin_propertiestab.php');
  echo $this->EndTab();
}
    
if( $this->_HasSufficientPermissions('groups') ) {
  echo $this->StartTab('groups',$params);
  include(__DIR__.'/function.admin_groupstab.php');
  echo $this->EndTab();
}
if( $this->_HasSufficientPermissions('users') ) {
  ...
  include(__DIR__.'/action.userhistory.php');
  echo $this->EndTab();
  
  echo $this->StartTab('admin',$params);
  include(__DIR__.'/function.admin_admintab.php');
  echo $this->EndTab();
}
