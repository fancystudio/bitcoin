<?php
$lang['use_or'] = 'Ergebnisse finden, in denen irgend eines der W&ouml;rter enthalten ist';
$lang['param_detailpage'] = 'Kann nur f&uuml;r Ergebnisse von Modulen verwendet werden. Mit diesem Parameter kann eine abweichende Detailseite f&uuml;r die Ergebnisse festgelegt werden. Dies ist zum Beispiel dann n&uuml;tzlich, wenn die Detailansicht auf einer Seite mit einem anderen Template angezeigt werden soll. <em>(<strong>Hinweis:</strong> Module haben die M&ouml;glichkeit, diesen Parameter zu &uuml;berschreiben.)</em>';
...
$lang['confirm_clearstats'] = 'Wollen Sie wirklich alle Statistiken unwiderruflich l&ouml;schen?';
...
$lang['param_pageid'] = 'Funktioniert nur bei Verwendung von &#039;keywords&#039;. Dieser Parameter kann verwendet werden, um f&uuml;r die Ausgabe der Ergebnisse eine andere Seite festzulegen. Hier muss die jeweilige Seiten-ID angegeben werden.';
...
$lang['param_passthru'] = 'Gibt die benannten Parameter an die festgelegten Module weiter. Das Format f&uuml;r jeden dieser Parameter lautet: &quot;passtru_MODULENAME_PARAMNAME=&#039;value&#039;&quot;, zum Beispiel &quot;passthru_News_detailpage=&#039;newsdetails&#039;&quot;';
...
$lang['param_resultpage'] = 'Die Seite, auf der die Suchergebnisse angezeigt werden sollen. Dies kann entweder ein Seiten-Alias oder eine Seiten-ID sein. Damit k&ouml;nnen die Suchergebnisse in einem anderem Template als das Suchformular angezeigt werden.';
$lang['prompt_alpharesults'] = 'Die Suchergebnisse alphabetisch anstatt nach deren Gewicht sortieren';
$lang['description'] = 'Modul f&uuml;r die Suche in den Inhalten der Webseite und den Modulen.';
...
$lang['default_stopwords'] = 'aber, alle, als, am, an, andere, anderen, anderes, auch, auf, aus, bei, beide, bevor, bin, bis, bist, da, dadurch, daher, danach, dann, darum, das, da&szlig;, dass, dein, deine, deinen, deines, dem, den, der, deren, des, deshalb, dessen, die, dies, dieser, dieses, doch, dort, du, durch, ein, eine, einem, einen, einer, eines, einige, einigen, einiger, er, es, euer, eure, euren, eurer, eures, ferner, f&uuml;r, gegen, gewesen, habe, haben, hat, hatte, hatten, hattest, hattet, hier, hinter, hoch, ich, ihnen, ihr, ihre, ihren, ihres, im, in, irgend, ist, ja, jede, jedem, jeden, jeder, jedes, jemand, jener, jenes, jetzt, kann, kannst, k&ouml;nnen, k&ouml;nnt, machen, mal, mehr, mein, meine, meinen, meisten, mich, mir, mit, mu&szlig;, m&uuml;ssen, mu&szlig;t, musst, m&uuml;&szlig;t, nach, nachdem, nein, nicht, nun, nur, oberhalb, oder, runter, sehr, seid, sein, seine, seinen, seines, selbe, selben, selber, selbst, sich, sie, sind, so, solche, solchen, solcher, soll, sollen, sollst, sollt, sonst, soweit, sowie, tat, tun, tut, &uuml;ber, und, unser, unsere, unseren, unserer, unseres, unter, unterhalb, vom, von, vor, w&auml;hrend, wann, war, waren, warst, warum, was, weil, weiter, weitere, welche, welcher, wenn, wer, werde, werden, werdet, weshalb, wessen, wie, wieder, wieso, wir, wird, wirst, wo, woher, wohin, zu, zum, zur, zwischen';
$lang['prompt_resetstopwords'] = 'Nicht zu indizierende W&ouml;rter aus Sprachdatei laden';
...
<p>Daf&uuml;r m&uuml;ssen Sie lediglich den folgenden Tag irgendwo in Ihrer Seite aufrufen <em>&amp;lt;!-- pageAttribute: NotSearchable --&amp;gt;</em></p>
