...
$lang['param_detailpage'] = 'Usato solo per combinare risultati dai moduli, questo parametro permette specificare una differente pagina per i risultati. Questo &egrave; utile se, per esempio, mostrate sempre le viste di dettaglio in una pagina con un template diverso.  <em>(<strong>Nota:</strong> i moduli hanno la possibilit&agrave; di sovrascrivere questo parametro.)</em>';
...
un, uno, una, il, lo, le, la, gli, i, e, ma, se, o, oppure, perch&egrave;, come, fino, sino, mentre, di, a, da, con, su, per, tra, fra, contro, nel, nello, nella, nei, 
attraverso, durante, prima, dopo, sopra, sotto, gi&ugrave;
dentro, fuori, acceso, spento, ancora, oltre, poi, qui, qua, l&igrave;, l&agrave;, quando, dove, perch&eacute;, come, tutto, tutti, qualsiasi, entrambe, entrambi, ogni, pi&ugrave;, altro, no, nessuno, nessuna, nessun, non, solo, quindi, anche, molto';
