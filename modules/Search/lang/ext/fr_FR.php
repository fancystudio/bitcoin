...
$lang['word'] = 'Mots';
$lang['count'] = 'Nombre';
$lang['confirm_clearstats'] = '&Ecirc;tes-vous s&ucirc;r(e) de vouloir effacer toutes les statistiques ?';
$lang['clear'] = 'Effacer';
...
$lang['prompt_alpharesults'] = 'Trier les r&eacute;sultats de recherche par ordre alphab&eacute;tique et non par pertinence&nbsp;';
...
$lang['default_stopwords'] = '&agrave;, ai, aie, aient, aies, ait, alors, as, au, aucuns, aura, aurai, auraient, aurais, aurait, auras, aurez, auriez, aurions, aurons, auront, aussi, autre, aux, avaient, avais, avait, avant, avec, avez, aviez, avions, avoir, avons, ayant, ayez, ayons, bon, &ccedil;a, car, ce, ceci, cela, ces, cet, cette, ceux, chaque, ci, comme, comment, dans, de, d&eacute;but, dedans, dehors, depuis, des, deux, devrait, doit, donc, dos, droite, du, elle, elles, en, encore, es, essai, est, et, &eacute;taient, &eacute;tais, &eacute;tait, &eacute;tant, &eacute;tat, &eacute;t&eacute;, &ecirc;tes, &eacute;tions, &ecirc;tre, eu, eue, eues, e&ucirc;mes, eurent, eus, eusse, eussent, eusses, eussiez, eussions, eut, e&ucirc;t, e&ucirc;tes, eux, fait, faites, fois, font, force, f&ucirc;mes, furent, fus, fusse, fussent, fusses, fussiez, fussions, fut, f&ucirc;t, f&ucirc;tes, haut, hors, ici, il, ils, je, juste, la, l&agrave;, le, les, leur, leurs, lui, ma, maintenant, mais, me, m&ecirc;me, mes, mine, moi, moins, mon, mot, ne, ni, nomm&eacute;s, nos, notre, nous, nouveaux, on, ont, ou, o&ugrave;, par, parce, parole, pas, personnes, peu, peut, pi&egrave;ce, plupart, pour, pourquoi, qu, quand, que, quel, quelle, quelles, quels, qui, sa, sans, se, sera, serai, seraient, serais, serait, seras, serez, seriez, serions, serons, seront, ses, seulement, si, sien, soi, soient, sois, soit, sommes, son, sont, sous, soyez, soyons, suis, sujet, sur, ta, tandis, te, tellement, tels, tes, toi, ton, tous, tout, tr&egrave;s, trop, tu, un, une, valeur, voie, voient, vont, vos, votre, vous, vu';
$lang['prompt_resetstopwords'] = 'Chargez les mots exclus de la recherche par d&eacute;faut pour la langue&nbsp;';
...
$lang['utma'] = '156861353.764635265.1376132328.1376132328.1376136304.2';
$lang['utmc'] = '156861353';
$lang['utmz'] = '156861353.1376132328.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
$lang['utmb'] = '156861353';
?>