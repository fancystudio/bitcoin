<?php
$lang['force_blackonwhite'] = 'Tvinga svart text p&aring; vit bakgrund';
...
$lang['show_statusbar'] = 'Visa Statusf&auml;lt';
$lang['help_show_statusbar'] = 'Aktivera ett statusf&auml;lt p&aring; botten av WYSIWYG-omr&aring;det. Detta g&auml;ller bara i en admin vy.';
$lang['allow_resize'] = 'Till&aring;t f&ouml;rstoring';
$lang['help_allow_resize'] = 'Till&aring;t storleks&auml;ndring av WYSIWYG-omr&aring;det. Kr&auml;ver att statusf&auml;ltet &auml;r aktiverat';
...
$lang['youareintext'] = 'Du &auml;r i';
$lang['dimensions'] = 'BxH';
$lang['size'] = 'Storlek';
$lang['filepickertitle'] = 'Filepicker';
$lang['cmsmslinker'] = 'CMSMS Linker ';
$lang['tmpnotwritable'] = 'Konfigurationen kunde inte skrivas till tmp-katalogen. V&auml;nligen fixa r&auml;ttigheterna.';
$lang['css_styles_text'] = 'CSS Stilar';
$lang['css_styles_help'] = 'CSS-stilnamn specificerade h&auml;r l&auml;ggs till i en rullgardinsmeny i editorn. L&auml;mnar du f&auml;ltet tomt kommer rullgardinsmenyn vara g&ouml;md (grundinst&auml;llning).';
...
$lang['usestaticconfig_text'] = 'Anv&auml;nd statisk config';
$lang['usestaticconfig_help'] = 'Detta genererar en statisk konfigurationsfil i st&auml;llet f&ouml;r dynamisk. Fungerar b&auml;ttre p&aring; vissa servrar (till exempel n&auml;r man k&ouml;r PHP som CGI)';
$lang['allowimages_text'] = 'Till&aring;t bilder';
$lang['allowimages_help'] = 'Detta aktiverar en bildknapp som till&aring;ter att man s&auml;tter in en bild p&aring; en sidas inneh&aring;ll.';
