...
if(isset($_SESSION['EditãCiaCien']['view']) && !isset($params['view']))
{
	$params['view'] = $_SESSION['EditãCiaCien']['view'];
}
...
echo EditãCiaCienViews::adminItems($this,$id,$returnid,$view,$items);	

$_SESSION['EditãCiaCien']['view'] = $view->getView();