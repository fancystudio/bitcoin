...
{
  unset($_SESSION['modules']['EditãCiaCien']['calendar']['scope']);
}
...
elseif(isset($_SESSION['modules']['EditãCiaCien']['calendar']['scope']))
{
  $scope = $_SESSION['modules']['EditãCiaCien']['calendar']['scope'];
}
else
{
  $scope = time();
...
if(!isset($params['forget_scope']))
{
  $_SESSION['modules']['EditãCiaCien']['calendar']['scope'] = $scope;
}
