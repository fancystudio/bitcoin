...
$fields[] = 'btc_k_dispozci_na_predaj';
$fields[] = 'EUR_k_dispozci_na_nkup';
$fields[] = 'mara_v_Percent_na_predaj';
$fields[] = 'mara_v_Percent_na_nkup';
...
$form = new CMSForm('EditãCiaCien', $id,'defaultadmin',$returnid);
...
$export =  new CMSForm('EditãCiaCien', $id,'export',$returnid);
